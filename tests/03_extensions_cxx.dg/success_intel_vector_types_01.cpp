...
{
    // 128
    __attribute__((vector_size(16))) float v128;
    __attribute__((vector_size(16))) int v128i;
    __attribute__((vector_size(16))) double v128d;
    ...
    // 256
    __attribute__((vector_size(32))) float v256;
    __attribute__((vector_size(32))) int v256i;
    __attribute__((vector_size(32))) double v256d;
    ...
    // 512
    __attribute__((vector_size(64))) float v512;
    __attribute__((vector_size(64))) int v512i;
    __attribute__((vector_size(64))) double v512d;
