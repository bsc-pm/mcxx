...
public:
   ...
   ~TestPtr()
   {
       using ::std::cout;
       if (m_ptr == UNINITED_PTR) {
          cout << "testpointer.h" << '[' << 62 << ']'
               << "WARNING! DELETEING unitialized "
               << m_className << "ptr at "
               << this << '\n';
       }
       else if (m_ptr == DESTROYED_PTR) {
          cout << "testpointer.h" << '[' << 68 << ']'
   ...
   TestPtr &operator=(TestPtr const &rhs)
   {
    ...
    TestPtr &operator=(PtrStates rhs)
    {
       ...
       m_ptr = rhs;
       if (m_ptr == UNINITED_PTR) {
          cout << "testpointer.h" << '[' << 104 << ']'
               << "WARNING assigning from "
               << m_className << " unitialized ptr\n";
       }
       else if (m_ptr == ZERO) {
           cout << "testpointer.h" << '[' << 109 << ']'
                << "WARNING! assigning from "
                << m_className << " dead temporary.\n";
       }
       else if (m_ptr == DESTROYED_PTR) {
           cout << "testpointer.h" << '[' << 114 << ']'
                << "ERROR! assigning from "
                << m_className << " deleted value!\n";
       }
       return *this;
    ...
    void validate() const
    {
       using ::std::cout;
       if (m_ptr == UNINITED_PTR) {
          cout << "testpointer.h" << '[' << 130 << ']'
               << "INVALID DATA"
               << m_className << " unitialized ptr\n";
       }
       else if (m_ptr == ZERO) {
           cout << "testpointer.h" << '[' << 135 << ']'
                << "INVALID DATA"
                << m_className << " dead temporary.\n";
       }
       else if (m_ptr == DESTROYED_PTR) {
           cout << "testpointer.h" << '[' << 140 << ']'
                << "INVALID DATA"
                << m_className << " deleted value!\n";
       }
    }
...
public:
    ...
    Y &operator=(::mojo::fnresult<Y> src)
    {
...
public:
    ...
    Z &operator=(::mojo::temporary<Z> src)
    {
        using ::std::swap;
    ...
    Z &operator=(::mojo::fnresult<Z> src)
    {
...
public:
    ...
    {}
     ...
     W(::mojo::fnresult<W> src)
        : m_ptr(src->m_ptr)
    {
        src->release();
    }

    W(::mojo::temporary<W> src)
        : m_ptr(src->m_ptr)
    {
        src->release();
    }
    ...
    W &operator=(::mojo::temporary<W> src)
    {
        src->m_ptr.swap(m_ptr);
        src->release();
        return *this;
    ...
    W &operator=(::mojo::fnresult<W> src)
    {
...
public:
    ...
    X(::mojo::fnresult<X> src)
    {
        src->release();
    }

    X(::mojo::temporary<X> src)
    {
        src->release();
    }
    ...
    X &operator=(::mojo::temporary<X> src)
    {
        src->release();
        return *this;
    }

    X &operator=(::mojo::fnresult<X> src)
    {
...
public:
    ...
    V &operator=(::mojo::fnresult<V> src)
    {
...
public:
    ...
    U &operator=(::mojo::temporary<U> src)
    {
    ...
    U &operator=(::mojo::fnresult<U> src)
    {
...
void Discriminate(Y&) { std::cerr << __PRETTY_FUNCTION__; }
void Discriminate(mojo::temporary<Y>) { std::cerr << __PRETTY_FUNCTION__; }
void Discriminate(mojo::constant<Y>) { std::cerr << __PRETTY_FUNCTION__; }
...
int main()
{
    cout << ("Y nonConstLValue(A_PTR)") << "\n"; Y nonConstLValue(A_PTR) ; cout << '\n';;
    cout << ("const Y constLValue(A_PTR)") << "\n"; const Y constLValue(A_PTR) ; cout << '\n';;

    cout << ("Y y1(constLValue)") << "\n"; Y y1(constLValue) ; cout << '\n';;
    cout << ("Y y2(nonConstLValue)") << "\n"; Y y2(nonConstLValue) ; cout << '\n';;
    cout << ("Y y3(MakeConstY())") << "\n"; Y y3(MakeConstY()) ; cout << '\n';;
    cout << ("Y y4(MakeY())") << "\n"; Y y4(MakeY()) ; cout << '\n';;
    ...
    {
        cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" << endl;
        cout << ("Discriminate(Y(A_PTR))") << "\n"; Discriminate(Y(A_PTR)) ; cout << '\n';;
        cout << ("Discriminate(MakeY())") << "\n"; Discriminate(MakeY()) ; cout << '\n';;
        cout << ("Discriminate(constLValue)") << "\n"; Discriminate(constLValue) ; cout << '\n';;
        cout << ("Discriminate(nonConstLValue)") << "\n"; Discriminate(nonConstLValue) ; cout << '\n';;
        cout << "<><><><><><><><><><><><><><><><><><><><>" << endl;
    }
    {
        cout << "=======================================" << endl;
        cout << ("y1 = constLValue") << "\n"; y1 = constLValue ; cout << '\n';;
        cout << ("y2 = nonConstLValue") << "\n"; y2 = nonConstLValue ; cout << '\n';;
        cout << ("y3 = MakeConstY()") << "\n"; y3 = MakeConstY() ; cout << '\n';;
        cout << ("y4 = MakeY()") << "\n"; y4 = MakeY() ; cout << '\n';;
        cout << ("y4.validate()") << "\n"; y4.validate() ; cout << '\n';;
        cout << "---------------------------------------" << endl;
    ...
    {
        cout << "+++++++++++++++++++++++++++++++++++++++" << endl;
        cout << ("Z nonConstZLValue(A_PTR)") << "\n"; Z nonConstZLValue(A_PTR) ; cout << '\n';;
        cout << ("const Z constZLValue(A_PTR)") << "\n"; const Z constZLValue(A_PTR) ; cout << '\n';;

        cout << ("Z z1(constZLValue)") << "\n"; Z z1(constZLValue) ; cout << '\n';;
        cout << ("Z z2(nonConstZLValue)") << "\n"; Z z2(nonConstZLValue) ; cout << '\n';;
        cout << ("Z z3(MakeConstZ())") << "\n"; Z z3(MakeConstZ()) ; cout << '\n';;
        cout << ("Z z4(MakeZ())") << "\n"; Z z4(MakeZ()) ; cout << '\n';;
        cout << ("z4.validate()") << "\n"; z4.validate() ; cout << '\n';;
        cout << "#######################################" << endl;
        ...
        {
            cout << "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$" << endl;
            cout << ("z1 = constZLValue") << "\n"; z1 = constZLValue ; cout << '\n';;
            cout << ("z2 = nonConstZLValue") << "\n"; z2 = nonConstZLValue ; cout << '\n';;
            cout << ("z3 = MakeConstZ()") << "\n"; z3 = MakeConstZ() ; cout << '\n';;
            cout << ("z4 = MakeZ()") << "\n"; z4 = MakeZ() ; cout << '\n';;
            cout << ("z4.validate()") << "\n"; z4.validate() ; cout << '\n';;
            cout << "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@" << endl;
...

    {
        ...
        cout << ("y1 = Y(A_PTR) + y3 + y4") << "\n"; y1 = Y(A_PTR) + y3 + y4 ; cout << '\n';;
        cout << ("y1.validate()") << "\n"; y1.validate() ; cout << '\n';;

        cout << ("y1 = MakeY() + MakeY() + MakeY()") << "\n"; y1 = MakeY() + MakeY() + MakeY() ; cout << '\n';;
        cout << ("y1.validate()") << "\n"; y1.validate() ; cout << '\n';;
        cout << "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%" << endl;
...

    {
        ...
        cout << ("Y y1(A_PTR)") << "\n"; Y y1(A_PTR) ; cout << '\n';;
        cout << ("TakeY(y1)") << "\n"; TakeY(y1) ; cout << '\n';;
        cout << ("TakeConstY(Y(A_PTR) )") << "\n"; TakeConstY(Y(A_PTR) ) ; cout << '\n';;
        cout << ("Z z1(A_PTR)") << "\n"; Z z1(A_PTR) ; cout << '\n';;
        cout << ("TakeZ( z1 )") << "\n"; TakeZ( z1 ) ; cout << '\n';;
        cout << ("TakeConstZ(Z(A_PTR) )") << "\n"; TakeConstZ(Z(A_PTR) ) ; cout << '\n';;
    ...
    }
    {
        ...
        cout << ("y_vec.push_back(MakeY() )") << "\n"; y_vec.push_back(MakeY() ) ; cout << '\n';;

        cout << ("y_vec[0].validate()") << "\n"; y_vec[0].validate() ; cout << '\n';;
