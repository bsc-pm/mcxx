...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_double_type(), 16);
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_float_type(), 16);
...
parameter_info_t p[1];p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[1];p[0].type_info = get_vector_type(get_double_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[1];p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[1];p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[1];p[0].type_info = get_const_qualified_type(get_pointer_type(get_char_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_double_type(), 16);
p[1].type_info = get_const_qualified_type(get_pointer_type(get_double_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_const_qualified_type(get_pointer_type(get_vector_type(get_float_type(), 8)));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[1];p[0].type_info = get_const_qualified_type(get_pointer_type(get_double_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[1];p[0].type_info = get_const_qualified_type(get_pointer_type(get_float_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[3];p[0].type_info = get_vector_type(get_char_type(), 16);
...
parameter_info_t p[3];p[0].type_info = get_vector_type(get_char_type(), 8);
...
parameter_info_t p[2];p[0].type_info = get_pointer_type(get_vector_type(get_signed_long_long_int_type(), 16));
...
parameter_info_t p[2];p[0].type_info = get_pointer_type(get_double_type());
p[1].type_info = get_vector_type(get_double_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_pointer_type(get_float_type());
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_pointer_type(get_unsigned_long_long_int_type());
...
parameter_info_t p[1];p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_signed_int_type(), 16);
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_char_type(), 8);
p[1].type_info = get_vector_type(get_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_char_type(), 16);
p[1].type_info = get_vector_type(get_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 8);
...
parameter_info_t p[2];p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[1];p[0].type_info = get_vector_type(get_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[1];p[0].type_info = get_vector_type(get_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[3];p[0].type_info = get_vector_type(get_double_type(), 16);
p[1].type_info = get_vector_type(get_double_type(), 16);
...
parameter_info_t p[3];p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
...
parameter_info_t p[2];p[0].type_info = get_pointer_type(get_char_type());
p[1].type_info = get_vector_type(get_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_pointer_type(get_vector_type(get_float_type(), 8));
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[2];p[0].type_info = get_signed_int_type();
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]));
})
;
...
parameter_info_t p[4];p[0].type_info = get_signed_short_int_type();
...
parameter_info_t p[8];p[0].type_info = get_char_type();
