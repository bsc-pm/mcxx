...
sym___builtin_neon_vabalsv2si->kind = SK_FUNCTION;sym___builtin_neon_vabalsv2si->do_not_print = 1;
sym___builtin_neon_vabalsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
...
sym___builtin_neon_vabalsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabalsv4hi->do_not_print = 1;
sym___builtin_neon_vabalsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
...
sym___builtin_neon_vabalsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabalsv8qi->do_not_print = 1;
sym___builtin_neon_vabalsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
...
sym___builtin_neon_vabaluv2si->kind = SK_FUNCTION;sym___builtin_neon_vabaluv2si->do_not_print = 1;
sym___builtin_neon_vabaluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabaluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabaluv4hi->do_not_print = 1;
sym___builtin_neon_vabaluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabaluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabaluv8qi->do_not_print = 1;
sym___builtin_neon_vabaluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabasv16qi->kind = SK_FUNCTION;sym___builtin_neon_vabasv16qi->do_not_print = 1;
sym___builtin_neon_vabasv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
...
sym___builtin_neon_vabasv2si->kind = SK_FUNCTION;sym___builtin_neon_vabasv2si->do_not_print = 1;
sym___builtin_neon_vabasv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
...
sym___builtin_neon_vabasv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabasv4hi->do_not_print = 1;
sym___builtin_neon_vabasv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
...
sym___builtin_neon_vabasv4si->kind = SK_FUNCTION;sym___builtin_neon_vabasv4si->do_not_print = 1;
sym___builtin_neon_vabasv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
...
sym___builtin_neon_vabasv8hi->kind = SK_FUNCTION;sym___builtin_neon_vabasv8hi->do_not_print = 1;
sym___builtin_neon_vabasv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
...
sym___builtin_neon_vabasv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabasv8qi->do_not_print = 1;
sym___builtin_neon_vabasv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
...
sym___builtin_neon_vabauv16qi->kind = SK_FUNCTION;sym___builtin_neon_vabauv16qi->do_not_print = 1;
sym___builtin_neon_vabauv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabauv2si->kind = SK_FUNCTION;sym___builtin_neon_vabauv2si->do_not_print = 1;
sym___builtin_neon_vabauv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabauv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabauv4hi->do_not_print = 1;
sym___builtin_neon_vabauv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabauv4si->kind = SK_FUNCTION;sym___builtin_neon_vabauv4si->do_not_print = 1;
sym___builtin_neon_vabauv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabauv8hi->kind = SK_FUNCTION;sym___builtin_neon_vabauv8hi->do_not_print = 1;
sym___builtin_neon_vabauv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabauv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabauv8qi->do_not_print = 1;
sym___builtin_neon_vabauv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vabdfv2sf->kind = SK_FUNCTION;sym___builtin_neon_vabdfv2sf->do_not_print = 1;
sym___builtin_neon_vabdfv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vabdfv4sf->kind = SK_FUNCTION;sym___builtin_neon_vabdfv4sf->do_not_print = 1;
sym___builtin_neon_vabdfv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
...
sym___builtin_neon_vabdlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vabdlsv2si->do_not_print = 1;
sym___builtin_neon_vabdlsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
...
sym___builtin_neon_vabdlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabdlsv4hi->do_not_print = 1;
sym___builtin_neon_vabdlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
...
sym___builtin_neon_vabdlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabdlsv8qi->do_not_print = 1;
sym___builtin_neon_vabdlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
...
sym___builtin_neon_vabdluv2si->kind = SK_FUNCTION;sym___builtin_neon_vabdluv2si->do_not_print = 1;
sym___builtin_neon_vabdluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabdluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabdluv4hi->do_not_print = 1;
sym___builtin_neon_vabdluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabdluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabdluv8qi->do_not_print = 1;
sym___builtin_neon_vabdluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabdsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vabdsv16qi->do_not_print = 1;
sym___builtin_neon_vabdsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
...
sym___builtin_neon_vabdsv2si->kind = SK_FUNCTION;sym___builtin_neon_vabdsv2si->do_not_print = 1;
sym___builtin_neon_vabdsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabdsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabdsv4hi->do_not_print = 1;
sym___builtin_neon_vabdsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabdsv4si->kind = SK_FUNCTION;sym___builtin_neon_vabdsv4si->do_not_print = 1;
sym___builtin_neon_vabdsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
...
sym___builtin_neon_vabdsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vabdsv8hi->do_not_print = 1;
sym___builtin_neon_vabdsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
...
sym___builtin_neon_vabdsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabdsv8qi->do_not_print = 1;
sym___builtin_neon_vabdsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabduv16qi->kind = SK_FUNCTION;sym___builtin_neon_vabduv16qi->do_not_print = 1;
sym___builtin_neon_vabduv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabduv2si->kind = SK_FUNCTION;sym___builtin_neon_vabduv2si->do_not_print = 1;
sym___builtin_neon_vabduv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabduv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabduv4hi->do_not_print = 1;
sym___builtin_neon_vabduv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabduv4si->kind = SK_FUNCTION;sym___builtin_neon_vabduv4si->do_not_print = 1;
sym___builtin_neon_vabduv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabduv8hi->kind = SK_FUNCTION;sym___builtin_neon_vabduv8hi->do_not_print = 1;
sym___builtin_neon_vabduv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabduv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabduv8qi->do_not_print = 1;
sym___builtin_neon_vabduv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vabsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vabsv16qi->do_not_print = 1;
sym___builtin_neon_vabsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
...
sym___builtin_neon_vabsv2sf->kind = SK_FUNCTION;sym___builtin_neon_vabsv2sf->do_not_print = 1;
sym___builtin_neon_vabsv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vabsv2si->kind = SK_FUNCTION;sym___builtin_neon_vabsv2si->do_not_print = 1;
sym___builtin_neon_vabsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
...
sym___builtin_neon_vabsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vabsv4hi->do_not_print = 1;
sym___builtin_neon_vabsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
...
sym___builtin_neon_vabsv4sf->kind = SK_FUNCTION;sym___builtin_neon_vabsv4sf->do_not_print = 1;
sym___builtin_neon_vabsv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
...
sym___builtin_neon_vabsv4si->kind = SK_FUNCTION;sym___builtin_neon_vabsv4si->do_not_print = 1;
sym___builtin_neon_vabsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
...
sym___builtin_neon_vabsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vabsv8hi->do_not_print = 1;
sym___builtin_neon_vabsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
...
sym___builtin_neon_vabsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vabsv8qi->do_not_print = 1;
sym___builtin_neon_vabsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
...
sym___builtin_neon_vaddhnv2di->kind = SK_FUNCTION;sym___builtin_neon_vaddhnv2di->do_not_print = 1;
sym___builtin_neon_vaddhnv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
...
sym___builtin_neon_vaddhnv4si->kind = SK_FUNCTION;sym___builtin_neon_vaddhnv4si->do_not_print = 1;
sym___builtin_neon_vaddhnv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddhnv8hi->kind = SK_FUNCTION;sym___builtin_neon_vaddhnv8hi->do_not_print = 1;
sym___builtin_neon_vaddhnv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vaddlsv2si->do_not_print = 1;
sym___builtin_neon_vaddlsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vaddlsv4hi->do_not_print = 1;
sym___builtin_neon_vaddlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vaddlsv8qi->do_not_print = 1;
sym___builtin_neon_vaddlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddluv2si->kind = SK_FUNCTION;sym___builtin_neon_vaddluv2si->do_not_print = 1;
sym___builtin_neon_vaddluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vaddluv4hi->do_not_print = 1;
sym___builtin_neon_vaddluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vaddluv8qi->do_not_print = 1;
sym___builtin_neon_vaddluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddv2sf->kind = SK_FUNCTION;sym___builtin_neon_vaddv2sf->do_not_print = 1;
sym___builtin_neon_vaddv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddv4sf->kind = SK_FUNCTION;sym___builtin_neon_vaddv4sf->do_not_print = 1;
sym___builtin_neon_vaddv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddwsv2si->kind = SK_FUNCTION;sym___builtin_neon_vaddwsv2si->do_not_print = 1;
sym___builtin_neon_vaddwsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddwsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vaddwsv4hi->do_not_print = 1;
sym___builtin_neon_vaddwsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddwsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vaddwsv8qi->do_not_print = 1;
sym___builtin_neon_vaddwsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddwuv2si->kind = SK_FUNCTION;sym___builtin_neon_vaddwuv2si->do_not_print = 1;
sym___builtin_neon_vaddwuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddwuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vaddwuv4hi->do_not_print = 1;
sym___builtin_neon_vaddwuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vaddwuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vaddwuv8qi->do_not_print = 1;
sym___builtin_neon_vaddwuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vbsldi->kind = SK_FUNCTION;sym___builtin_neon_vbsldi->do_not_print = 1;
...
sym___builtin_neon_vbslv16qi->kind = SK_FUNCTION;sym___builtin_neon_vbslv16qi->do_not_print = 1;
sym___builtin_neon_vbslv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vbslv2di->kind = SK_FUNCTION;sym___builtin_neon_vbslv2di->do_not_print = 1;
sym___builtin_neon_vbslv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
...
sym___builtin_neon_vbslv2sf->kind = SK_FUNCTION;sym___builtin_neon_vbslv2sf->do_not_print = 1;
sym___builtin_neon_vbslv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vbslv2si->kind = SK_FUNCTION;sym___builtin_neon_vbslv2si->do_not_print = 1;
sym___builtin_neon_vbslv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vbslv4hi->kind = SK_FUNCTION;sym___builtin_neon_vbslv4hi->do_not_print = 1;
sym___builtin_neon_vbslv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vbslv4sf->kind = SK_FUNCTION;sym___builtin_neon_vbslv4sf->do_not_print = 1;
sym___builtin_neon_vbslv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
...
sym___builtin_neon_vbslv4si->kind = SK_FUNCTION;sym___builtin_neon_vbslv4si->do_not_print = 1;
sym___builtin_neon_vbslv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vbslv8hi->kind = SK_FUNCTION;sym___builtin_neon_vbslv8hi->do_not_print = 1;
sym___builtin_neon_vbslv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vbslv8qi->kind = SK_FUNCTION;sym___builtin_neon_vbslv8qi->do_not_print = 1;
sym___builtin_neon_vbslv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vcagev2sf->kind = SK_FUNCTION;sym___builtin_neon_vcagev2sf->do_not_print = 1;
sym___builtin_neon_vcagev2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcagev4sf->kind = SK_FUNCTION;sym___builtin_neon_vcagev4sf->do_not_print = 1;
sym___builtin_neon_vcagev4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcagtv2sf->kind = SK_FUNCTION;sym___builtin_neon_vcagtv2sf->do_not_print = 1;
sym___builtin_neon_vcagtv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcagtv4sf->kind = SK_FUNCTION;sym___builtin_neon_vcagtv4sf->do_not_print = 1;
sym___builtin_neon_vcagtv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vceqv16qi->kind = SK_FUNCTION;sym___builtin_neon_vceqv16qi->do_not_print = 1;
sym___builtin_neon_vceqv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vceqv2sf->kind = SK_FUNCTION;sym___builtin_neon_vceqv2sf->do_not_print = 1;
sym___builtin_neon_vceqv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vceqv2si->kind = SK_FUNCTION;sym___builtin_neon_vceqv2si->do_not_print = 1;
sym___builtin_neon_vceqv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vceqv4hi->kind = SK_FUNCTION;sym___builtin_neon_vceqv4hi->do_not_print = 1;
sym___builtin_neon_vceqv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vceqv4sf->kind = SK_FUNCTION;sym___builtin_neon_vceqv4sf->do_not_print = 1;
sym___builtin_neon_vceqv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vceqv4si->kind = SK_FUNCTION;sym___builtin_neon_vceqv4si->do_not_print = 1;
sym___builtin_neon_vceqv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vceqv8hi->kind = SK_FUNCTION;sym___builtin_neon_vceqv8hi->do_not_print = 1;
sym___builtin_neon_vceqv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vceqv8qi->kind = SK_FUNCTION;sym___builtin_neon_vceqv8qi->do_not_print = 1;
sym___builtin_neon_vceqv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgeuv16qi->kind = SK_FUNCTION;sym___builtin_neon_vcgeuv16qi->do_not_print = 1;
sym___builtin_neon_vcgeuv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgeuv2si->kind = SK_FUNCTION;sym___builtin_neon_vcgeuv2si->do_not_print = 1;
sym___builtin_neon_vcgeuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgeuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vcgeuv4hi->do_not_print = 1;
sym___builtin_neon_vcgeuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgeuv4si->kind = SK_FUNCTION;sym___builtin_neon_vcgeuv4si->do_not_print = 1;
sym___builtin_neon_vcgeuv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgeuv8hi->kind = SK_FUNCTION;sym___builtin_neon_vcgeuv8hi->do_not_print = 1;
sym___builtin_neon_vcgeuv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgeuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vcgeuv8qi->do_not_print = 1;
sym___builtin_neon_vcgeuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgev16qi->kind = SK_FUNCTION;sym___builtin_neon_vcgev16qi->do_not_print = 1;
sym___builtin_neon_vcgev16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgev2sf->kind = SK_FUNCTION;sym___builtin_neon_vcgev2sf->do_not_print = 1;
sym___builtin_neon_vcgev2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgev2si->kind = SK_FUNCTION;sym___builtin_neon_vcgev2si->do_not_print = 1;
sym___builtin_neon_vcgev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgev4hi->kind = SK_FUNCTION;sym___builtin_neon_vcgev4hi->do_not_print = 1;
sym___builtin_neon_vcgev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgev4sf->kind = SK_FUNCTION;sym___builtin_neon_vcgev4sf->do_not_print = 1;
sym___builtin_neon_vcgev4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgev4si->kind = SK_FUNCTION;sym___builtin_neon_vcgev4si->do_not_print = 1;
sym___builtin_neon_vcgev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgev8hi->kind = SK_FUNCTION;sym___builtin_neon_vcgev8hi->do_not_print = 1;
sym___builtin_neon_vcgev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgev8qi->kind = SK_FUNCTION;sym___builtin_neon_vcgev8qi->do_not_print = 1;
sym___builtin_neon_vcgev8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtuv16qi->kind = SK_FUNCTION;sym___builtin_neon_vcgtuv16qi->do_not_print = 1;
sym___builtin_neon_vcgtuv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtuv2si->kind = SK_FUNCTION;sym___builtin_neon_vcgtuv2si->do_not_print = 1;
sym___builtin_neon_vcgtuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vcgtuv4hi->do_not_print = 1;
sym___builtin_neon_vcgtuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtuv4si->kind = SK_FUNCTION;sym___builtin_neon_vcgtuv4si->do_not_print = 1;
sym___builtin_neon_vcgtuv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtuv8hi->kind = SK_FUNCTION;sym___builtin_neon_vcgtuv8hi->do_not_print = 1;
sym___builtin_neon_vcgtuv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vcgtuv8qi->do_not_print = 1;
sym___builtin_neon_vcgtuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtv16qi->kind = SK_FUNCTION;sym___builtin_neon_vcgtv16qi->do_not_print = 1;
sym___builtin_neon_vcgtv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtv2sf->kind = SK_FUNCTION;sym___builtin_neon_vcgtv2sf->do_not_print = 1;
sym___builtin_neon_vcgtv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtv2si->kind = SK_FUNCTION;sym___builtin_neon_vcgtv2si->do_not_print = 1;
sym___builtin_neon_vcgtv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtv4hi->kind = SK_FUNCTION;sym___builtin_neon_vcgtv4hi->do_not_print = 1;
sym___builtin_neon_vcgtv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtv4sf->kind = SK_FUNCTION;sym___builtin_neon_vcgtv4sf->do_not_print = 1;
sym___builtin_neon_vcgtv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtv4si->kind = SK_FUNCTION;sym___builtin_neon_vcgtv4si->do_not_print = 1;
sym___builtin_neon_vcgtv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtv8hi->kind = SK_FUNCTION;sym___builtin_neon_vcgtv8hi->do_not_print = 1;
sym___builtin_neon_vcgtv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcgtv8qi->kind = SK_FUNCTION;sym___builtin_neon_vcgtv8qi->do_not_print = 1;
sym___builtin_neon_vcgtv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vclsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vclsv16qi->do_not_print = 1;
sym___builtin_neon_vclsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclsv2si->kind = SK_FUNCTION;sym___builtin_neon_vclsv2si->do_not_print = 1;
sym___builtin_neon_vclsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vclsv4hi->do_not_print = 1;
sym___builtin_neon_vclsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclsv4si->kind = SK_FUNCTION;sym___builtin_neon_vclsv4si->do_not_print = 1;
sym___builtin_neon_vclsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vclsv8hi->do_not_print = 1;
sym___builtin_neon_vclsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vclsv8qi->do_not_print = 1;
sym___builtin_neon_vclsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclzv16qi->kind = SK_FUNCTION;sym___builtin_neon_vclzv16qi->do_not_print = 1;
sym___builtin_neon_vclzv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclzv2si->kind = SK_FUNCTION;sym___builtin_neon_vclzv2si->do_not_print = 1;
sym___builtin_neon_vclzv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclzv4hi->kind = SK_FUNCTION;sym___builtin_neon_vclzv4hi->do_not_print = 1;
sym___builtin_neon_vclzv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclzv4si->kind = SK_FUNCTION;sym___builtin_neon_vclzv4si->do_not_print = 1;
sym___builtin_neon_vclzv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclzv8hi->kind = SK_FUNCTION;sym___builtin_neon_vclzv8hi->do_not_print = 1;
sym___builtin_neon_vclzv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vclzv8qi->kind = SK_FUNCTION;sym___builtin_neon_vclzv8qi->do_not_print = 1;
sym___builtin_neon_vclzv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcntv16qi->kind = SK_FUNCTION;sym___builtin_neon_vcntv16qi->do_not_print = 1;
sym___builtin_neon_vcntv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcntv8qi->kind = SK_FUNCTION;sym___builtin_neon_vcntv8qi->do_not_print = 1;
sym___builtin_neon_vcntv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcombinedi->kind = SK_FUNCTION;sym___builtin_neon_vcombinedi->do_not_print = 1;
sym___builtin_neon_vcombinedi->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
...
sym___builtin_neon_vcombinev2sf->kind = SK_FUNCTION;sym___builtin_neon_vcombinev2sf->do_not_print = 1;
sym___builtin_neon_vcombinev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcombinev2si->kind = SK_FUNCTION;sym___builtin_neon_vcombinev2si->do_not_print = 1;
sym___builtin_neon_vcombinev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcombinev4hi->kind = SK_FUNCTION;sym___builtin_neon_vcombinev4hi->do_not_print = 1;
sym___builtin_neon_vcombinev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcombinev8qi->kind = SK_FUNCTION;sym___builtin_neon_vcombinev8qi->do_not_print = 1;
sym___builtin_neon_vcombinev8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcreatedi->kind = SK_FUNCTION;sym___builtin_neon_vcreatedi->do_not_print = 1;
...
sym___builtin_neon_vcreatev2sf->kind = SK_FUNCTION;sym___builtin_neon_vcreatev2sf->do_not_print = 1;
sym___builtin_neon_vcreatev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcreatev2si->kind = SK_FUNCTION;sym___builtin_neon_vcreatev2si->do_not_print = 1;
sym___builtin_neon_vcreatev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcreatev4hi->kind = SK_FUNCTION;sym___builtin_neon_vcreatev4hi->do_not_print = 1;
sym___builtin_neon_vcreatev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcreatev8qi->kind = SK_FUNCTION;sym___builtin_neon_vcreatev8qi->do_not_print = 1;
sym___builtin_neon_vcreatev8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcvts_nv2sf->kind = SK_FUNCTION;sym___builtin_neon_vcvts_nv2sf->do_not_print = 1;
sym___builtin_neon_vcvts_nv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vcvts_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vcvts_nv2si->do_not_print = 1;
sym___builtin_neon_vcvts_nv2si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcvts_nv4sf->kind = SK_FUNCTION;sym___builtin_neon_vcvts_nv4sf->do_not_print = 1;
sym___builtin_neon_vcvts_nv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcvts_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vcvts_nv4si->do_not_print = 1;
sym___builtin_neon_vcvts_nv4si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcvtsv2sf->kind = SK_FUNCTION;sym___builtin_neon_vcvtsv2sf->do_not_print = 1;
sym___builtin_neon_vcvtsv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcvtsv2si->kind = SK_FUNCTION;sym___builtin_neon_vcvtsv2si->do_not_print = 1;
sym___builtin_neon_vcvtsv2si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcvtsv4sf->kind = SK_FUNCTION;sym___builtin_neon_vcvtsv4sf->do_not_print = 1;
sym___builtin_neon_vcvtsv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcvtsv4si->kind = SK_FUNCTION;sym___builtin_neon_vcvtsv4si->do_not_print = 1;
sym___builtin_neon_vcvtsv4si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcvtu_nv2sf->kind = SK_FUNCTION;sym___builtin_neon_vcvtu_nv2sf->do_not_print = 1;
sym___builtin_neon_vcvtu_nv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcvtu_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vcvtu_nv2si->do_not_print = 1;
sym___builtin_neon_vcvtu_nv2si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcvtu_nv4sf->kind = SK_FUNCTION;sym___builtin_neon_vcvtu_nv4sf->do_not_print = 1;
sym___builtin_neon_vcvtu_nv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcvtu_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vcvtu_nv4si->do_not_print = 1;
sym___builtin_neon_vcvtu_nv4si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vcvtuv2sf->kind = SK_FUNCTION;sym___builtin_neon_vcvtuv2sf->do_not_print = 1;
sym___builtin_neon_vcvtuv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcvtuv2si->kind = SK_FUNCTION;sym___builtin_neon_vcvtuv2si->do_not_print = 1;
sym___builtin_neon_vcvtuv2si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcvtuv4sf->kind = SK_FUNCTION;sym___builtin_neon_vcvtuv4sf->do_not_print = 1;
sym___builtin_neon_vcvtuv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vcvtuv4si->kind = SK_FUNCTION;sym___builtin_neon_vcvtuv4si->do_not_print = 1;
sym___builtin_neon_vcvtuv4si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vdup_lanedi->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanedi->do_not_print = 1;
...
sym___builtin_neon_vdup_lanev16qi->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev16qi->do_not_print = 1;
sym___builtin_neon_vdup_lanev16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_lanev2di->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev2di->do_not_print = 1;
sym___builtin_neon_vdup_lanev2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_lanev2sf->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev2sf->do_not_print = 1;
sym___builtin_neon_vdup_lanev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev2si->do_not_print = 1;
sym___builtin_neon_vdup_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev4hi->do_not_print = 1;
sym___builtin_neon_vdup_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_lanev4sf->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev4sf->do_not_print = 1;
sym___builtin_neon_vdup_lanev4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev4si->do_not_print = 1;
sym___builtin_neon_vdup_lanev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev8hi->do_not_print = 1;
sym___builtin_neon_vdup_lanev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_lanev8qi->kind = SK_FUNCTION;sym___builtin_neon_vdup_lanev8qi->do_not_print = 1;
sym___builtin_neon_vdup_lanev8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vdup_ndi->kind = SK_FUNCTION;sym___builtin_neon_vdup_ndi->do_not_print = 1;
...
sym___builtin_neon_vdup_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv16qi->do_not_print = 1;
sym___builtin_neon_vdup_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
...
sym___builtin_neon_vdup_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv2di->do_not_print = 1;
sym___builtin_neon_vdup_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vdup_nv2sf->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv2sf->do_not_print = 1;
sym___builtin_neon_vdup_nv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vdup_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv2si->do_not_print = 1;
sym___builtin_neon_vdup_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
...
sym___builtin_neon_vdup_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv4hi->do_not_print = 1;
sym___builtin_neon_vdup_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
...
sym___builtin_neon_vdup_nv4sf->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv4sf->do_not_print = 1;
sym___builtin_neon_vdup_nv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_float_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vdup_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv4si->do_not_print = 1;
sym___builtin_neon_vdup_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vdup_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv8hi->do_not_print = 1;
sym___builtin_neon_vdup_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vdup_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vdup_nv8qi->do_not_print = 1;
sym___builtin_neon_vdup_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_char_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vextdi->kind = SK_FUNCTION;sym___builtin_neon_vextdi->do_not_print = 1;
...
sym___builtin_neon_vextv16qi->kind = SK_FUNCTION;sym___builtin_neon_vextv16qi->do_not_print = 1;
sym___builtin_neon_vextv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vextv2di->kind = SK_FUNCTION;sym___builtin_neon_vextv2di->do_not_print = 1;
sym___builtin_neon_vextv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vextv2sf->kind = SK_FUNCTION;sym___builtin_neon_vextv2sf->do_not_print = 1;
sym___builtin_neon_vextv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vextv2si->kind = SK_FUNCTION;sym___builtin_neon_vextv2si->do_not_print = 1;
sym___builtin_neon_vextv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vextv4hi->kind = SK_FUNCTION;sym___builtin_neon_vextv4hi->do_not_print = 1;
sym___builtin_neon_vextv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vextv4sf->kind = SK_FUNCTION;sym___builtin_neon_vextv4sf->do_not_print = 1;
sym___builtin_neon_vextv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
...
sym___builtin_neon_vextv4si->kind = SK_FUNCTION;sym___builtin_neon_vextv4si->do_not_print = 1;
sym___builtin_neon_vextv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vextv8hi->kind = SK_FUNCTION;sym___builtin_neon_vextv8hi->do_not_print = 1;
sym___builtin_neon_vextv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vextv8qi->kind = SK_FUNCTION;sym___builtin_neon_vextv8qi->do_not_print = 1;
sym___builtin_neon_vextv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vget_highv16qi->kind = SK_FUNCTION;sym___builtin_neon_vget_highv16qi->do_not_print = 1;
sym___builtin_neon_vget_highv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vget_highv2di->kind = SK_FUNCTION;sym___builtin_neon_vget_highv2di->do_not_print = 1;
...
sym___builtin_neon_vget_highv4sf->kind = SK_FUNCTION;sym___builtin_neon_vget_highv4sf->do_not_print = 1;
sym___builtin_neon_vget_highv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vget_highv4si->kind = SK_FUNCTION;sym___builtin_neon_vget_highv4si->do_not_print = 1;
sym___builtin_neon_vget_highv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vget_highv8hi->kind = SK_FUNCTION;sym___builtin_neon_vget_highv8hi->do_not_print = 1;
sym___builtin_neon_vget_highv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vget_lanedi->kind = SK_FUNCTION;sym___builtin_neon_vget_lanedi->do_not_print = 1;
...
sym___builtin_neon_vget_laneuv16qi->kind = SK_FUNCTION;sym___builtin_neon_vget_laneuv16qi->do_not_print = 1;
...
sym___builtin_neon_vget_laneuv2si->kind = SK_FUNCTION;sym___builtin_neon_vget_laneuv2si->do_not_print = 1;
...
sym___builtin_neon_vget_laneuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vget_laneuv4hi->do_not_print = 1;
...
sym___builtin_neon_vget_laneuv4si->kind = SK_FUNCTION;sym___builtin_neon_vget_laneuv4si->do_not_print = 1;
...
sym___builtin_neon_vget_laneuv8hi->kind = SK_FUNCTION;sym___builtin_neon_vget_laneuv8hi->do_not_print = 1;
...
sym___builtin_neon_vget_laneuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vget_laneuv8qi->do_not_print = 1;
...
sym___builtin_neon_vget_lanev16qi->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev16qi->do_not_print = 1;
...
sym___builtin_neon_vget_lanev2di->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev2di->do_not_print = 1;
...
sym___builtin_neon_vget_lanev2sf->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev2sf->do_not_print = 1;
...
sym___builtin_neon_vget_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev2si->do_not_print = 1;
...
sym___builtin_neon_vget_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev4hi->do_not_print = 1;
...
sym___builtin_neon_vget_lanev4sf->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev4sf->do_not_print = 1;
...
sym___builtin_neon_vget_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev4si->do_not_print = 1;
...
sym___builtin_neon_vget_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev8hi->do_not_print = 1;
...
sym___builtin_neon_vget_lanev8qi->kind = SK_FUNCTION;sym___builtin_neon_vget_lanev8qi->do_not_print = 1;
...
sym___builtin_neon_vget_lowv16qi->kind = SK_FUNCTION;sym___builtin_neon_vget_lowv16qi->do_not_print = 1;
sym___builtin_neon_vget_lowv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vget_lowv2di->kind = SK_FUNCTION;sym___builtin_neon_vget_lowv2di->do_not_print = 1;
...
sym___builtin_neon_vget_lowv4sf->kind = SK_FUNCTION;sym___builtin_neon_vget_lowv4sf->do_not_print = 1;
sym___builtin_neon_vget_lowv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vget_lowv4si->kind = SK_FUNCTION;sym___builtin_neon_vget_lowv4si->do_not_print = 1;
sym___builtin_neon_vget_lowv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vget_lowv8hi->kind = SK_FUNCTION;sym___builtin_neon_vget_lowv8hi->do_not_print = 1;
sym___builtin_neon_vget_lowv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vhaddsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vhaddsv16qi->do_not_print = 1;
sym___builtin_neon_vhaddsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhaddsv2si->kind = SK_FUNCTION;sym___builtin_neon_vhaddsv2si->do_not_print = 1;
sym___builtin_neon_vhaddsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhaddsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vhaddsv4hi->do_not_print = 1;
sym___builtin_neon_vhaddsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhaddsv4si->kind = SK_FUNCTION;sym___builtin_neon_vhaddsv4si->do_not_print = 1;
sym___builtin_neon_vhaddsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhaddsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vhaddsv8hi->do_not_print = 1;
sym___builtin_neon_vhaddsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhaddsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vhaddsv8qi->do_not_print = 1;
sym___builtin_neon_vhaddsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhadduv16qi->kind = SK_FUNCTION;sym___builtin_neon_vhadduv16qi->do_not_print = 1;
sym___builtin_neon_vhadduv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhadduv2si->kind = SK_FUNCTION;sym___builtin_neon_vhadduv2si->do_not_print = 1;
sym___builtin_neon_vhadduv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhadduv4hi->kind = SK_FUNCTION;sym___builtin_neon_vhadduv4hi->do_not_print = 1;
sym___builtin_neon_vhadduv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhadduv4si->kind = SK_FUNCTION;sym___builtin_neon_vhadduv4si->do_not_print = 1;
sym___builtin_neon_vhadduv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhadduv8hi->kind = SK_FUNCTION;sym___builtin_neon_vhadduv8hi->do_not_print = 1;
sym___builtin_neon_vhadduv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhadduv8qi->kind = SK_FUNCTION;sym___builtin_neon_vhadduv8qi->do_not_print = 1;
sym___builtin_neon_vhadduv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vhsubsv16qi->do_not_print = 1;
sym___builtin_neon_vhsubsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubsv2si->kind = SK_FUNCTION;sym___builtin_neon_vhsubsv2si->do_not_print = 1;
sym___builtin_neon_vhsubsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vhsubsv4hi->do_not_print = 1;
sym___builtin_neon_vhsubsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubsv4si->kind = SK_FUNCTION;sym___builtin_neon_vhsubsv4si->do_not_print = 1;
sym___builtin_neon_vhsubsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vhsubsv8hi->do_not_print = 1;
sym___builtin_neon_vhsubsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vhsubsv8qi->do_not_print = 1;
sym___builtin_neon_vhsubsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubuv16qi->kind = SK_FUNCTION;sym___builtin_neon_vhsubuv16qi->do_not_print = 1;
sym___builtin_neon_vhsubuv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubuv2si->kind = SK_FUNCTION;sym___builtin_neon_vhsubuv2si->do_not_print = 1;
sym___builtin_neon_vhsubuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vhsubuv4hi->do_not_print = 1;
sym___builtin_neon_vhsubuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubuv4si->kind = SK_FUNCTION;sym___builtin_neon_vhsubuv4si->do_not_print = 1;
sym___builtin_neon_vhsubuv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubuv8hi->kind = SK_FUNCTION;sym___builtin_neon_vhsubuv8hi->do_not_print = 1;
sym___builtin_neon_vhsubuv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vhsubuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vhsubuv8qi->do_not_print = 1;
sym___builtin_neon_vhsubuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vld1di->kind = SK_FUNCTION;sym___builtin_neon_vld1di->do_not_print = 1;
...
sym___builtin_neon_vld1_dupdi->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupdi->do_not_print = 1;
...
sym___builtin_neon_vld1_dupv16qi->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv16qi->do_not_print = 1;
sym___builtin_neon_vld1_dupv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
...
sym___builtin_neon_vld1_dupv2di->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv2di->do_not_print = 1;
sym___builtin_neon_vld1_dupv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_long_long_int_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1_dupv2sf->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv2sf->do_not_print = 1;
sym___builtin_neon_vld1_dupv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vld1_dupv2si->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv2si->do_not_print = 1;
sym___builtin_neon_vld1_dupv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
...
sym___builtin_neon_vld1_dupv4hi->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv4hi->do_not_print = 1;
sym___builtin_neon_vld1_dupv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
...
sym___builtin_neon_vld1_dupv4sf->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv4sf->do_not_print = 1;
sym___builtin_neon_vld1_dupv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_float_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1_dupv4si->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv4si->do_not_print = 1;
sym___builtin_neon_vld1_dupv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_int_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1_dupv8hi->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv8hi->do_not_print = 1;
sym___builtin_neon_vld1_dupv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_short_int_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1_dupv8qi->kind = SK_FUNCTION;sym___builtin_neon_vld1_dupv8qi->do_not_print = 1;
sym___builtin_neon_vld1_dupv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_char_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1_lanedi->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanedi->do_not_print = 1;
...
sym___builtin_neon_vld1_lanev16qi->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev16qi->do_not_print = 1;
sym___builtin_neon_vld1_lanev16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
...
sym___builtin_neon_vld1_lanev2di->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev2di->do_not_print = 1;
sym___builtin_neon_vld1_lanev2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_long_long_int_type()));
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vld1_lanev2sf->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev2sf->do_not_print = 1;
sym___builtin_neon_vld1_lanev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vld1_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev2si->do_not_print = 1;
sym___builtin_neon_vld1_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
...
sym___builtin_neon_vld1_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev4hi->do_not_print = 1;
sym___builtin_neon_vld1_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
...
sym___builtin_neon_vld1_lanev4sf->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev4sf->do_not_print = 1;
sym___builtin_neon_vld1_lanev4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_float_type()));
p[1].type_info = get_vector_type(get_float_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vld1_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev4si->do_not_print = 1;
sym___builtin_neon_vld1_lanev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_int_type()));
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vld1_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev8hi->do_not_print = 1;
sym___builtin_neon_vld1_lanev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_short_int_type()));
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vld1_lanev8qi->kind = SK_FUNCTION;sym___builtin_neon_vld1_lanev8qi->do_not_print = 1;
sym___builtin_neon_vld1_lanev8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_char_type()));
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vld1v16qi->kind = SK_FUNCTION;sym___builtin_neon_vld1v16qi->do_not_print = 1;
sym___builtin_neon_vld1v16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_char_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1v2di->kind = SK_FUNCTION;sym___builtin_neon_vld1v2di->do_not_print = 1;
sym___builtin_neon_vld1v2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_long_long_int_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1v2sf->kind = SK_FUNCTION;sym___builtin_neon_vld1v2sf->do_not_print = 1;
sym___builtin_neon_vld1v2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_float_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1v2si->kind = SK_FUNCTION;sym___builtin_neon_vld1v2si->do_not_print = 1;
sym___builtin_neon_vld1v2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_int_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1v4hi->kind = SK_FUNCTION;sym___builtin_neon_vld1v4hi->do_not_print = 1;
sym___builtin_neon_vld1v4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_short_int_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1v4sf->kind = SK_FUNCTION;sym___builtin_neon_vld1v4sf->do_not_print = 1;
sym___builtin_neon_vld1v4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_float_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1v4si->kind = SK_FUNCTION;sym___builtin_neon_vld1v4si->do_not_print = 1;
sym___builtin_neon_vld1v4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_int_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1v8hi->kind = SK_FUNCTION;sym___builtin_neon_vld1v8hi->do_not_print = 1;
sym___builtin_neon_vld1v8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_short_int_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vld1v8qi->kind = SK_FUNCTION;sym___builtin_neon_vld1v8qi->do_not_print = 1;
sym___builtin_neon_vld1v8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_pointer_type(get_const_qualified_type(get_signed_char_type()));
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmaxfv2sf->kind = SK_FUNCTION;sym___builtin_neon_vmaxfv2sf->do_not_print = 1;
sym___builtin_neon_vmaxfv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxfv4sf->kind = SK_FUNCTION;sym___builtin_neon_vmaxfv4sf->do_not_print = 1;
sym___builtin_neon_vmaxfv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vmaxsv16qi->do_not_print = 1;
sym___builtin_neon_vmaxsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxsv2si->kind = SK_FUNCTION;sym___builtin_neon_vmaxsv2si->do_not_print = 1;
sym___builtin_neon_vmaxsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmaxsv4hi->do_not_print = 1;
sym___builtin_neon_vmaxsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxsv4si->kind = SK_FUNCTION;sym___builtin_neon_vmaxsv4si->do_not_print = 1;
sym___builtin_neon_vmaxsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vmaxsv8hi->do_not_print = 1;
sym___builtin_neon_vmaxsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmaxsv8qi->do_not_print = 1;
sym___builtin_neon_vmaxsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxuv16qi->kind = SK_FUNCTION;sym___builtin_neon_vmaxuv16qi->do_not_print = 1;
sym___builtin_neon_vmaxuv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxuv2si->kind = SK_FUNCTION;sym___builtin_neon_vmaxuv2si->do_not_print = 1;
sym___builtin_neon_vmaxuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmaxuv4hi->do_not_print = 1;
sym___builtin_neon_vmaxuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxuv4si->kind = SK_FUNCTION;sym___builtin_neon_vmaxuv4si->do_not_print = 1;
sym___builtin_neon_vmaxuv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxuv8hi->kind = SK_FUNCTION;sym___builtin_neon_vmaxuv8hi->do_not_print = 1;
sym___builtin_neon_vmaxuv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmaxuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmaxuv8qi->do_not_print = 1;
sym___builtin_neon_vmaxuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminfv2sf->kind = SK_FUNCTION;sym___builtin_neon_vminfv2sf->do_not_print = 1;
sym___builtin_neon_vminfv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminfv4sf->kind = SK_FUNCTION;sym___builtin_neon_vminfv4sf->do_not_print = 1;
sym___builtin_neon_vminfv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vminsv16qi->do_not_print = 1;
sym___builtin_neon_vminsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminsv2si->kind = SK_FUNCTION;sym___builtin_neon_vminsv2si->do_not_print = 1;
sym___builtin_neon_vminsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vminsv4hi->do_not_print = 1;
sym___builtin_neon_vminsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminsv4si->kind = SK_FUNCTION;sym___builtin_neon_vminsv4si->do_not_print = 1;
sym___builtin_neon_vminsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vminsv8hi->do_not_print = 1;
sym___builtin_neon_vminsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vminsv8qi->do_not_print = 1;
sym___builtin_neon_vminsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminuv16qi->kind = SK_FUNCTION;sym___builtin_neon_vminuv16qi->do_not_print = 1;
sym___builtin_neon_vminuv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminuv2si->kind = SK_FUNCTION;sym___builtin_neon_vminuv2si->do_not_print = 1;
sym___builtin_neon_vminuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vminuv4hi->do_not_print = 1;
sym___builtin_neon_vminuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminuv4si->kind = SK_FUNCTION;sym___builtin_neon_vminuv4si->do_not_print = 1;
sym___builtin_neon_vminuv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminuv8hi->kind = SK_FUNCTION;sym___builtin_neon_vminuv8hi->do_not_print = 1;
sym___builtin_neon_vminuv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vminuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vminuv8qi->do_not_print = 1;
sym___builtin_neon_vminuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmla_lanev2sf->kind = SK_FUNCTION;sym___builtin_neon_vmla_lanev2sf->do_not_print = 1;
sym___builtin_neon_vmla_lanev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
p[2].type_info = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vmla_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmla_lanev2si->do_not_print = 1;
sym___builtin_neon_vmla_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
p[3].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmla_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmla_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmla_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmla_lanev4sf->kind = SK_FUNCTION;sym___builtin_neon_vmla_lanev4sf->do_not_print = 1;
sym___builtin_neon_vmla_lanev4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
...
sym___builtin_neon_vmla_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vmla_lanev4si->do_not_print = 1;
sym___builtin_neon_vmla_lanev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
...
sym___builtin_neon_vmla_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vmla_lanev8hi->do_not_print = 1;
sym___builtin_neon_vmla_lanev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlals_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmlals_lanev2si->do_not_print = 1;
sym___builtin_neon_vmlals_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
...
sym___builtin_neon_vmlals_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlals_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmlals_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmlals_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlals_nv2si->do_not_print = 1;
sym___builtin_neon_vmlals_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlals_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlals_nv4hi->do_not_print = 1;
sym___builtin_neon_vmlals_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
...
sym___builtin_neon_vmlalsv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlalsv2si->do_not_print = 1;
sym___builtin_neon_vmlalsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlalsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlalsv4hi->do_not_print = 1;
sym___builtin_neon_vmlalsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlalsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmlalsv8qi->do_not_print = 1;
sym___builtin_neon_vmlalsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlalu_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmlalu_lanev2si->do_not_print = 1;
sym___builtin_neon_vmlalu_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmlalu_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlalu_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmlalu_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmlalu_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlalu_nv2si->do_not_print = 1;
sym___builtin_neon_vmlalu_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlalu_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlalu_nv4hi->do_not_print = 1;
sym___builtin_neon_vmlalu_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlaluv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlaluv2si->do_not_print = 1;
sym___builtin_neon_vmlaluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlaluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlaluv4hi->do_not_print = 1;
sym___builtin_neon_vmlaluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlaluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmlaluv8qi->do_not_print = 1;
sym___builtin_neon_vmlaluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmla_nv2sf->kind = SK_FUNCTION;sym___builtin_neon_vmla_nv2sf->do_not_print = 1;
sym___builtin_neon_vmla_nv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vmla_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmla_nv2si->do_not_print = 1;
sym___builtin_neon_vmla_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmla_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmla_nv4hi->do_not_print = 1;
sym___builtin_neon_vmla_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmla_nv4sf->kind = SK_FUNCTION;sym___builtin_neon_vmla_nv4sf->do_not_print = 1;
sym___builtin_neon_vmla_nv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
p[2].type_info = get_float_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmla_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vmla_nv4si->do_not_print = 1;
sym___builtin_neon_vmla_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmla_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vmla_nv8hi->do_not_print = 1;
sym___builtin_neon_vmla_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlav16qi->kind = SK_FUNCTION;sym___builtin_neon_vmlav16qi->do_not_print = 1;
sym___builtin_neon_vmlav16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlav2sf->kind = SK_FUNCTION;sym___builtin_neon_vmlav2sf->do_not_print = 1;
sym___builtin_neon_vmlav2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
p[2].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlav2si->kind = SK_FUNCTION;sym___builtin_neon_vmlav2si->do_not_print = 1;
sym___builtin_neon_vmlav2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlav4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlav4hi->do_not_print = 1;
sym___builtin_neon_vmlav4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlav4sf->kind = SK_FUNCTION;sym___builtin_neon_vmlav4sf->do_not_print = 1;
sym___builtin_neon_vmlav4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
p[2].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlav4si->kind = SK_FUNCTION;sym___builtin_neon_vmlav4si->do_not_print = 1;
sym___builtin_neon_vmlav4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlav8hi->kind = SK_FUNCTION;sym___builtin_neon_vmlav8hi->do_not_print = 1;
sym___builtin_neon_vmlav8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlav8qi->kind = SK_FUNCTION;sym___builtin_neon_vmlav8qi->do_not_print = 1;
sym___builtin_neon_vmlav8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmls_lanev2sf->kind = SK_FUNCTION;sym___builtin_neon_vmls_lanev2sf->do_not_print = 1;
sym___builtin_neon_vmls_lanev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
p[2].type_info = get_vector_type(get_float_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmls_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmls_lanev2si->do_not_print = 1;
sym___builtin_neon_vmls_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmls_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmls_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmls_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmls_lanev4sf->kind = SK_FUNCTION;sym___builtin_neon_vmls_lanev4sf->do_not_print = 1;
sym___builtin_neon_vmls_lanev4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
p[2].type_info = get_vector_type(get_float_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmls_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vmls_lanev4si->do_not_print = 1;
sym___builtin_neon_vmls_lanev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmls_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vmls_lanev8hi->do_not_print = 1;
sym___builtin_neon_vmls_lanev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmlsls_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmlsls_lanev2si->do_not_print = 1;
sym___builtin_neon_vmlsls_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmlsls_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlsls_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmlsls_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmlsls_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlsls_nv2si->do_not_print = 1;
sym___builtin_neon_vmlsls_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsls_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlsls_nv4hi->do_not_print = 1;
sym___builtin_neon_vmlsls_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlslsv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlslsv2si->do_not_print = 1;
sym___builtin_neon_vmlslsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlslsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlslsv4hi->do_not_print = 1;
sym___builtin_neon_vmlslsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlslsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmlslsv8qi->do_not_print = 1;
sym___builtin_neon_vmlslsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlslu_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmlslu_lanev2si->do_not_print = 1;
sym___builtin_neon_vmlslu_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmlslu_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlslu_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmlslu_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vmlslu_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlslu_nv2si->do_not_print = 1;
sym___builtin_neon_vmlslu_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlslu_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlslu_nv4hi->do_not_print = 1;
sym___builtin_neon_vmlslu_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsluv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlsluv2si->do_not_print = 1;
sym___builtin_neon_vmlsluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlsluv4hi->do_not_print = 1;
sym___builtin_neon_vmlsluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmlsluv8qi->do_not_print = 1;
sym___builtin_neon_vmlsluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmls_nv2sf->kind = SK_FUNCTION;sym___builtin_neon_vmls_nv2sf->do_not_print = 1;
sym___builtin_neon_vmls_nv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
p[2].type_info = get_float_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmls_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmls_nv2si->do_not_print = 1;
sym___builtin_neon_vmls_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmls_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmls_nv4hi->do_not_print = 1;
sym___builtin_neon_vmls_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmls_nv4sf->kind = SK_FUNCTION;sym___builtin_neon_vmls_nv4sf->do_not_print = 1;
sym___builtin_neon_vmls_nv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
p[2].type_info = get_float_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmls_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vmls_nv4si->do_not_print = 1;
sym___builtin_neon_vmls_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmls_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vmls_nv8hi->do_not_print = 1;
sym___builtin_neon_vmls_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vmlsv16qi->do_not_print = 1;
sym___builtin_neon_vmlsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsv2sf->kind = SK_FUNCTION;sym___builtin_neon_vmlsv2sf->do_not_print = 1;
sym___builtin_neon_vmlsv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
p[2].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vmlsv2si->do_not_print = 1;
sym___builtin_neon_vmlsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmlsv4hi->do_not_print = 1;
sym___builtin_neon_vmlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsv4sf->kind = SK_FUNCTION;sym___builtin_neon_vmlsv4sf->do_not_print = 1;
sym___builtin_neon_vmlsv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
p[2].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsv4si->kind = SK_FUNCTION;sym___builtin_neon_vmlsv4si->do_not_print = 1;
sym___builtin_neon_vmlsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vmlsv8hi->do_not_print = 1;
sym___builtin_neon_vmlsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmlsv8qi->do_not_print = 1;
sym___builtin_neon_vmlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmovlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vmovlsv2si->do_not_print = 1;
sym___builtin_neon_vmovlsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmovlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmovlsv4hi->do_not_print = 1;
sym___builtin_neon_vmovlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmovlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmovlsv8qi->do_not_print = 1;
sym___builtin_neon_vmovlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmovluv2si->kind = SK_FUNCTION;sym___builtin_neon_vmovluv2si->do_not_print = 1;
sym___builtin_neon_vmovluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmovluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmovluv4hi->do_not_print = 1;
sym___builtin_neon_vmovluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmovluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmovluv8qi->do_not_print = 1;
sym___builtin_neon_vmovluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmovnv2di->kind = SK_FUNCTION;sym___builtin_neon_vmovnv2di->do_not_print = 1;
sym___builtin_neon_vmovnv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmovnv4si->kind = SK_FUNCTION;sym___builtin_neon_vmovnv4si->do_not_print = 1;
sym___builtin_neon_vmovnv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmovnv8hi->kind = SK_FUNCTION;sym___builtin_neon_vmovnv8hi->do_not_print = 1;
sym___builtin_neon_vmovnv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmulfv2sf->kind = SK_FUNCTION;sym___builtin_neon_vmulfv2sf->do_not_print = 1;
sym___builtin_neon_vmulfv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmulfv4sf->kind = SK_FUNCTION;sym___builtin_neon_vmulfv4sf->do_not_print = 1;
sym___builtin_neon_vmulfv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmul_lanev2sf->kind = SK_FUNCTION;sym___builtin_neon_vmul_lanev2sf->do_not_print = 1;
sym___builtin_neon_vmul_lanev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmul_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmul_lanev2si->do_not_print = 1;
sym___builtin_neon_vmul_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmul_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmul_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmul_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmul_lanev4sf->kind = SK_FUNCTION;sym___builtin_neon_vmul_lanev4sf->do_not_print = 1;
sym___builtin_neon_vmul_lanev4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmul_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vmul_lanev4si->do_not_print = 1;
sym___builtin_neon_vmul_lanev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmul_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vmul_lanev8hi->do_not_print = 1;
sym___builtin_neon_vmul_lanev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmullpv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmullpv8qi->do_not_print = 1;
sym___builtin_neon_vmullpv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmulls_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmulls_lanev2si->do_not_print = 1;
sym___builtin_neon_vmulls_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmulls_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmulls_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmulls_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmulls_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmulls_nv2si->do_not_print = 1;
sym___builtin_neon_vmulls_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmulls_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmulls_nv4hi->do_not_print = 1;
sym___builtin_neon_vmulls_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
...
sym___builtin_neon_vmullsv2si->kind = SK_FUNCTION;sym___builtin_neon_vmullsv2si->do_not_print = 1;
sym___builtin_neon_vmullsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmullsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmullsv4hi->do_not_print = 1;
sym___builtin_neon_vmullsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmullsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmullsv8qi->do_not_print = 1;
sym___builtin_neon_vmullsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmullu_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vmullu_lanev2si->do_not_print = 1;
sym___builtin_neon_vmullu_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmullu_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vmullu_lanev4hi->do_not_print = 1;
sym___builtin_neon_vmullu_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vmullu_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmullu_nv2si->do_not_print = 1;
sym___builtin_neon_vmullu_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmullu_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmullu_nv4hi->do_not_print = 1;
sym___builtin_neon_vmullu_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmulluv2si->kind = SK_FUNCTION;sym___builtin_neon_vmulluv2si->do_not_print = 1;
sym___builtin_neon_vmulluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmulluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmulluv4hi->do_not_print = 1;
sym___builtin_neon_vmulluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmulluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmulluv8qi->do_not_print = 1;
sym___builtin_neon_vmulluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmul_nv2sf->kind = SK_FUNCTION;sym___builtin_neon_vmul_nv2sf->do_not_print = 1;
sym___builtin_neon_vmul_nv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vmul_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vmul_nv2si->do_not_print = 1;
sym___builtin_neon_vmul_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmul_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmul_nv4hi->do_not_print = 1;
sym___builtin_neon_vmul_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmul_nv4sf->kind = SK_FUNCTION;sym___builtin_neon_vmul_nv4sf->do_not_print = 1;
sym___builtin_neon_vmul_nv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_float_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmul_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vmul_nv4si->do_not_print = 1;
sym___builtin_neon_vmul_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmul_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vmul_nv8hi->do_not_print = 1;
sym___builtin_neon_vmul_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmulpv16qi->kind = SK_FUNCTION;sym___builtin_neon_vmulpv16qi->do_not_print = 1;
sym___builtin_neon_vmulpv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmulpv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmulpv8qi->do_not_print = 1;
sym___builtin_neon_vmulpv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vmvnv16qi->kind = SK_FUNCTION;sym___builtin_neon_vmvnv16qi->do_not_print = 1;
sym___builtin_neon_vmvnv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmvnv2si->kind = SK_FUNCTION;sym___builtin_neon_vmvnv2si->do_not_print = 1;
sym___builtin_neon_vmvnv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmvnv4hi->kind = SK_FUNCTION;sym___builtin_neon_vmvnv4hi->do_not_print = 1;
sym___builtin_neon_vmvnv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmvnv4si->kind = SK_FUNCTION;sym___builtin_neon_vmvnv4si->do_not_print = 1;
sym___builtin_neon_vmvnv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmvnv8hi->kind = SK_FUNCTION;sym___builtin_neon_vmvnv8hi->do_not_print = 1;
sym___builtin_neon_vmvnv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vmvnv8qi->kind = SK_FUNCTION;sym___builtin_neon_vmvnv8qi->do_not_print = 1;
sym___builtin_neon_vmvnv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vnegv16qi->kind = SK_FUNCTION;sym___builtin_neon_vnegv16qi->do_not_print = 1;
sym___builtin_neon_vnegv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vnegv2sf->kind = SK_FUNCTION;sym___builtin_neon_vnegv2sf->do_not_print = 1;
sym___builtin_neon_vnegv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vnegv2si->kind = SK_FUNCTION;sym___builtin_neon_vnegv2si->do_not_print = 1;
sym___builtin_neon_vnegv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vnegv4hi->kind = SK_FUNCTION;sym___builtin_neon_vnegv4hi->do_not_print = 1;
sym___builtin_neon_vnegv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vnegv4sf->kind = SK_FUNCTION;sym___builtin_neon_vnegv4sf->do_not_print = 1;
sym___builtin_neon_vnegv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vnegv4si->kind = SK_FUNCTION;sym___builtin_neon_vnegv4si->do_not_print = 1;
sym___builtin_neon_vnegv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vnegv8hi->kind = SK_FUNCTION;sym___builtin_neon_vnegv8hi->do_not_print = 1;
sym___builtin_neon_vnegv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vnegv8qi->kind = SK_FUNCTION;sym___builtin_neon_vnegv8qi->do_not_print = 1;
sym___builtin_neon_vnegv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpadalsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vpadalsv16qi->do_not_print = 1;
sym___builtin_neon_vpadalsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadalsv2si->kind = SK_FUNCTION;sym___builtin_neon_vpadalsv2si->do_not_print = 1;
...
sym___builtin_neon_vpadalsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpadalsv4hi->do_not_print = 1;
sym___builtin_neon_vpadalsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadalsv4si->kind = SK_FUNCTION;sym___builtin_neon_vpadalsv4si->do_not_print = 1;
sym___builtin_neon_vpadalsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadalsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vpadalsv8hi->do_not_print = 1;
sym___builtin_neon_vpadalsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadalsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpadalsv8qi->do_not_print = 1;
sym___builtin_neon_vpadalsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadaluv16qi->kind = SK_FUNCTION;sym___builtin_neon_vpadaluv16qi->do_not_print = 1;
sym___builtin_neon_vpadaluv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadaluv2si->kind = SK_FUNCTION;sym___builtin_neon_vpadaluv2si->do_not_print = 1;
...
sym___builtin_neon_vpadaluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpadaluv4hi->do_not_print = 1;
sym___builtin_neon_vpadaluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadaluv4si->kind = SK_FUNCTION;sym___builtin_neon_vpadaluv4si->do_not_print = 1;
sym___builtin_neon_vpadaluv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadaluv8hi->kind = SK_FUNCTION;sym___builtin_neon_vpadaluv8hi->do_not_print = 1;
sym___builtin_neon_vpadaluv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpadaluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpadaluv8qi->do_not_print = 1;
sym___builtin_neon_vpadaluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpaddlsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vpaddlsv16qi->do_not_print = 1;
sym___builtin_neon_vpaddlsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vpaddlsv2si->do_not_print = 1;
...
sym___builtin_neon_vpaddlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpaddlsv4hi->do_not_print = 1;
sym___builtin_neon_vpaddlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddlsv4si->kind = SK_FUNCTION;sym___builtin_neon_vpaddlsv4si->do_not_print = 1;
sym___builtin_neon_vpaddlsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddlsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vpaddlsv8hi->do_not_print = 1;
sym___builtin_neon_vpaddlsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpaddlsv8qi->do_not_print = 1;
sym___builtin_neon_vpaddlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddluv16qi->kind = SK_FUNCTION;sym___builtin_neon_vpaddluv16qi->do_not_print = 1;
sym___builtin_neon_vpaddluv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddluv2si->kind = SK_FUNCTION;sym___builtin_neon_vpaddluv2si->do_not_print = 1;
...
sym___builtin_neon_vpaddluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpaddluv4hi->do_not_print = 1;
sym___builtin_neon_vpaddluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddluv4si->kind = SK_FUNCTION;sym___builtin_neon_vpaddluv4si->do_not_print = 1;
sym___builtin_neon_vpaddluv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddluv8hi->kind = SK_FUNCTION;sym___builtin_neon_vpaddluv8hi->do_not_print = 1;
sym___builtin_neon_vpaddluv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpaddluv8qi->do_not_print = 1;
sym___builtin_neon_vpaddluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vpaddv2sf->kind = SK_FUNCTION;sym___builtin_neon_vpaddv2sf->do_not_print = 1;
sym___builtin_neon_vpaddv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpaddv2si->kind = SK_FUNCTION;sym___builtin_neon_vpaddv2si->do_not_print = 1;
sym___builtin_neon_vpaddv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpaddv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpaddv4hi->do_not_print = 1;
sym___builtin_neon_vpaddv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpaddv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpaddv8qi->do_not_print = 1;
sym___builtin_neon_vpaddv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpmaxfv2sf->kind = SK_FUNCTION;sym___builtin_neon_vpmaxfv2sf->do_not_print = 1;
sym___builtin_neon_vpmaxfv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpmaxsv2si->kind = SK_FUNCTION;sym___builtin_neon_vpmaxsv2si->do_not_print = 1;
sym___builtin_neon_vpmaxsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpmaxsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpmaxsv4hi->do_not_print = 1;
sym___builtin_neon_vpmaxsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpmaxsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpmaxsv8qi->do_not_print = 1;
sym___builtin_neon_vpmaxsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpmaxuv2si->kind = SK_FUNCTION;sym___builtin_neon_vpmaxuv2si->do_not_print = 1;
sym___builtin_neon_vpmaxuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpmaxuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpmaxuv4hi->do_not_print = 1;
sym___builtin_neon_vpmaxuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpmaxuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpmaxuv8qi->do_not_print = 1;
sym___builtin_neon_vpmaxuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpminfv2sf->kind = SK_FUNCTION;sym___builtin_neon_vpminfv2sf->do_not_print = 1;
sym___builtin_neon_vpminfv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpminsv2si->kind = SK_FUNCTION;sym___builtin_neon_vpminsv2si->do_not_print = 1;
sym___builtin_neon_vpminsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpminsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpminsv4hi->do_not_print = 1;
sym___builtin_neon_vpminsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpminsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpminsv8qi->do_not_print = 1;
sym___builtin_neon_vpminsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpminuv2si->kind = SK_FUNCTION;sym___builtin_neon_vpminuv2si->do_not_print = 1;
sym___builtin_neon_vpminuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpminuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vpminuv4hi->do_not_print = 1;
sym___builtin_neon_vpminuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vpminuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vpminuv8qi->do_not_print = 1;
sym___builtin_neon_vpminuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqabsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqabsv16qi->do_not_print = 1;
sym___builtin_neon_vqabsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqabsv2si->kind = SK_FUNCTION;sym___builtin_neon_vqabsv2si->do_not_print = 1;
sym___builtin_neon_vqabsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqabsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqabsv4hi->do_not_print = 1;
sym___builtin_neon_vqabsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqabsv4si->kind = SK_FUNCTION;sym___builtin_neon_vqabsv4si->do_not_print = 1;
sym___builtin_neon_vqabsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqabsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqabsv8hi->do_not_print = 1;
sym___builtin_neon_vqabsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqabsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqabsv8qi->do_not_print = 1;
sym___builtin_neon_vqabsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqaddsdi->kind = SK_FUNCTION;sym___builtin_neon_vqaddsdi->do_not_print = 1;
...
sym___builtin_neon_vqaddsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqaddsv16qi->do_not_print = 1;
sym___builtin_neon_vqaddsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqaddsv2di->kind = SK_FUNCTION;sym___builtin_neon_vqaddsv2di->do_not_print = 1;
sym___builtin_neon_vqaddsv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqaddsv2si->kind = SK_FUNCTION;sym___builtin_neon_vqaddsv2si->do_not_print = 1;
sym___builtin_neon_vqaddsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqaddsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqaddsv4hi->do_not_print = 1;
sym___builtin_neon_vqaddsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqaddsv4si->kind = SK_FUNCTION;sym___builtin_neon_vqaddsv4si->do_not_print = 1;
sym___builtin_neon_vqaddsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqaddsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqaddsv8hi->do_not_print = 1;
sym___builtin_neon_vqaddsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqaddsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqaddsv8qi->do_not_print = 1;
sym___builtin_neon_vqaddsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqaddudi->kind = SK_FUNCTION;sym___builtin_neon_vqaddudi->do_not_print = 1;
...
sym___builtin_neon_vqadduv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqadduv16qi->do_not_print = 1;
sym___builtin_neon_vqadduv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqadduv2di->kind = SK_FUNCTION;sym___builtin_neon_vqadduv2di->do_not_print = 1;
sym___builtin_neon_vqadduv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqadduv2si->kind = SK_FUNCTION;sym___builtin_neon_vqadduv2si->do_not_print = 1;
sym___builtin_neon_vqadduv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqadduv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqadduv4hi->do_not_print = 1;
sym___builtin_neon_vqadduv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqadduv4si->kind = SK_FUNCTION;sym___builtin_neon_vqadduv4si->do_not_print = 1;
sym___builtin_neon_vqadduv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqadduv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqadduv8hi->do_not_print = 1;
sym___builtin_neon_vqadduv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqadduv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqadduv8qi->do_not_print = 1;
sym___builtin_neon_vqadduv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmlal_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmlal_lanev2si->do_not_print = 1;
sym___builtin_neon_vqdmlal_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vqdmlal_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmlal_lanev4hi->do_not_print = 1;
sym___builtin_neon_vqdmlal_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vqdmlal_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmlal_nv2si->do_not_print = 1;
sym___builtin_neon_vqdmlal_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmlal_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmlal_nv4hi->do_not_print = 1;
sym___builtin_neon_vqdmlal_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmlalv2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmlalv2si->do_not_print = 1;
sym___builtin_neon_vqdmlalv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmlalv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmlalv4hi->do_not_print = 1;
sym___builtin_neon_vqdmlalv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmlsl_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmlsl_lanev2si->do_not_print = 1;
sym___builtin_neon_vqdmlsl_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vqdmlsl_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmlsl_lanev4hi->do_not_print = 1;
sym___builtin_neon_vqdmlsl_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[4]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[3].type_info = get_signed_int_type();
...
sym___builtin_neon_vqdmlsl_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmlsl_nv2si->do_not_print = 1;
sym___builtin_neon_vqdmlsl_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmlsl_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmlsl_nv4hi->do_not_print = 1;
sym___builtin_neon_vqdmlsl_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmlslv2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmlslv2si->do_not_print = 1;
sym___builtin_neon_vqdmlslv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmlslv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmlslv4hi->do_not_print = 1;
sym___builtin_neon_vqdmlslv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmulh_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmulh_lanev2si->do_not_print = 1;
sym___builtin_neon_vqdmulh_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmulh_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmulh_lanev4hi->do_not_print = 1;
sym___builtin_neon_vqdmulh_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmulh_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vqdmulh_lanev4si->do_not_print = 1;
sym___builtin_neon_vqdmulh_lanev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmulh_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmulh_lanev8hi->do_not_print = 1;
sym___builtin_neon_vqdmulh_lanev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmulh_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmulh_nv2si->do_not_print = 1;
sym___builtin_neon_vqdmulh_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmulh_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmulh_nv4hi->do_not_print = 1;
sym___builtin_neon_vqdmulh_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmulh_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqdmulh_nv4si->do_not_print = 1;
sym___builtin_neon_vqdmulh_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmulh_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmulh_nv8hi->do_not_print = 1;
sym___builtin_neon_vqdmulh_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmulhv2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmulhv2si->do_not_print = 1;
sym___builtin_neon_vqdmulhv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmulhv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmulhv4hi->do_not_print = 1;
sym___builtin_neon_vqdmulhv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmulhv4si->kind = SK_FUNCTION;sym___builtin_neon_vqdmulhv4si->do_not_print = 1;
sym___builtin_neon_vqdmulhv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmulhv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmulhv8hi->do_not_print = 1;
sym___builtin_neon_vqdmulhv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmull_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmull_lanev2si->do_not_print = 1;
sym___builtin_neon_vqdmull_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmull_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmull_lanev4hi->do_not_print = 1;
sym___builtin_neon_vqdmull_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqdmull_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmull_nv2si->do_not_print = 1;
sym___builtin_neon_vqdmull_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmull_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmull_nv4hi->do_not_print = 1;
sym___builtin_neon_vqdmull_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmullv2si->kind = SK_FUNCTION;sym___builtin_neon_vqdmullv2si->do_not_print = 1;
sym___builtin_neon_vqdmullv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqdmullv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqdmullv4hi->do_not_print = 1;
sym___builtin_neon_vqdmullv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqmovnsv2di->kind = SK_FUNCTION;sym___builtin_neon_vqmovnsv2di->do_not_print = 1;
sym___builtin_neon_vqmovnsv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqmovnsv4si->kind = SK_FUNCTION;sym___builtin_neon_vqmovnsv4si->do_not_print = 1;
sym___builtin_neon_vqmovnsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqmovnsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqmovnsv8hi->do_not_print = 1;
sym___builtin_neon_vqmovnsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqmovnuv2di->kind = SK_FUNCTION;sym___builtin_neon_vqmovnuv2di->do_not_print = 1;
sym___builtin_neon_vqmovnuv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqmovnuv4si->kind = SK_FUNCTION;sym___builtin_neon_vqmovnuv4si->do_not_print = 1;
sym___builtin_neon_vqmovnuv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqmovnuv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqmovnuv8hi->do_not_print = 1;
sym___builtin_neon_vqmovnuv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqmovunv2di->kind = SK_FUNCTION;sym___builtin_neon_vqmovunv2di->do_not_print = 1;
sym___builtin_neon_vqmovunv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqmovunv4si->kind = SK_FUNCTION;sym___builtin_neon_vqmovunv4si->do_not_print = 1;
sym___builtin_neon_vqmovunv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqmovunv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqmovunv8hi->do_not_print = 1;
sym___builtin_neon_vqmovunv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqnegv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqnegv16qi->do_not_print = 1;
sym___builtin_neon_vqnegv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqnegv2si->kind = SK_FUNCTION;sym___builtin_neon_vqnegv2si->do_not_print = 1;
sym___builtin_neon_vqnegv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqnegv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqnegv4hi->do_not_print = 1;
sym___builtin_neon_vqnegv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqnegv4si->kind = SK_FUNCTION;sym___builtin_neon_vqnegv4si->do_not_print = 1;
sym___builtin_neon_vqnegv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqnegv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqnegv8hi->do_not_print = 1;
sym___builtin_neon_vqnegv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqnegv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqnegv8qi->do_not_print = 1;
sym___builtin_neon_vqnegv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vqrdmulh_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulh_lanev2si->do_not_print = 1;
sym___builtin_neon_vqrdmulh_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqrdmulh_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulh_lanev4hi->do_not_print = 1;
sym___builtin_neon_vqrdmulh_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqrdmulh_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulh_lanev4si->do_not_print = 1;
sym___builtin_neon_vqrdmulh_lanev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqrdmulh_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulh_lanev8hi->do_not_print = 1;
sym___builtin_neon_vqrdmulh_lanev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vqrdmulh_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulh_nv2si->do_not_print = 1;
sym___builtin_neon_vqrdmulh_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrdmulh_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulh_nv4hi->do_not_print = 1;
sym___builtin_neon_vqrdmulh_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrdmulh_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulh_nv4si->do_not_print = 1;
sym___builtin_neon_vqrdmulh_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrdmulh_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulh_nv8hi->do_not_print = 1;
sym___builtin_neon_vqrdmulh_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_short_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrdmulhv2si->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulhv2si->do_not_print = 1;
sym___builtin_neon_vqrdmulhv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrdmulhv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulhv4hi->do_not_print = 1;
sym___builtin_neon_vqrdmulhv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrdmulhv4si->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulhv4si->do_not_print = 1;
sym___builtin_neon_vqrdmulhv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrdmulhv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqrdmulhv8hi->do_not_print = 1;
sym___builtin_neon_vqrdmulhv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshlsdi->kind = SK_FUNCTION;sym___builtin_neon_vqrshlsdi->do_not_print = 1;
...
sym___builtin_neon_vqrshlsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqrshlsv16qi->do_not_print = 1;
sym___builtin_neon_vqrshlsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshlsv2di->kind = SK_FUNCTION;sym___builtin_neon_vqrshlsv2di->do_not_print = 1;
sym___builtin_neon_vqrshlsv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vqrshlsv2si->do_not_print = 1;
sym___builtin_neon_vqrshlsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqrshlsv4hi->do_not_print = 1;
sym___builtin_neon_vqrshlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshlsv4si->kind = SK_FUNCTION;sym___builtin_neon_vqrshlsv4si->do_not_print = 1;
sym___builtin_neon_vqrshlsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshlsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqrshlsv8hi->do_not_print = 1;
sym___builtin_neon_vqrshlsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqrshlsv8qi->do_not_print = 1;
sym___builtin_neon_vqrshlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshludi->kind = SK_FUNCTION;sym___builtin_neon_vqrshludi->do_not_print = 1;
...
sym___builtin_neon_vqrshluv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqrshluv16qi->do_not_print = 1;
sym___builtin_neon_vqrshluv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshluv2di->kind = SK_FUNCTION;sym___builtin_neon_vqrshluv2di->do_not_print = 1;
sym___builtin_neon_vqrshluv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshluv2si->kind = SK_FUNCTION;sym___builtin_neon_vqrshluv2si->do_not_print = 1;
sym___builtin_neon_vqrshluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqrshluv4hi->do_not_print = 1;
sym___builtin_neon_vqrshluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshluv4si->kind = SK_FUNCTION;sym___builtin_neon_vqrshluv4si->do_not_print = 1;
sym___builtin_neon_vqrshluv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshluv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqrshluv8hi->do_not_print = 1;
sym___builtin_neon_vqrshluv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqrshluv8qi->do_not_print = 1;
sym___builtin_neon_vqrshluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrns_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqrshrns_nv2di->do_not_print = 1;
sym___builtin_neon_vqrshrns_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrns_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqrshrns_nv4si->do_not_print = 1;
sym___builtin_neon_vqrshrns_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrns_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqrshrns_nv8hi->do_not_print = 1;
sym___builtin_neon_vqrshrns_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrnu_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqrshrnu_nv2di->do_not_print = 1;
sym___builtin_neon_vqrshrnu_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrnu_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqrshrnu_nv4si->do_not_print = 1;
sym___builtin_neon_vqrshrnu_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrnu_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqrshrnu_nv8hi->do_not_print = 1;
sym___builtin_neon_vqrshrnu_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrun_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqrshrun_nv2di->do_not_print = 1;
sym___builtin_neon_vqrshrun_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrun_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqrshrun_nv4si->do_not_print = 1;
sym___builtin_neon_vqrshrun_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqrshrun_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqrshrun_nv8hi->do_not_print = 1;
sym___builtin_neon_vqrshrun_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlsdi->kind = SK_FUNCTION;sym___builtin_neon_vqshlsdi->do_not_print = 1;
...
sym___builtin_neon_vqshl_s_ndi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_s_ndi->do_not_print = 1;
...
sym___builtin_neon_vqshl_s_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_s_nv16qi->do_not_print = 1;
sym___builtin_neon_vqshl_s_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_s_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqshl_s_nv2di->do_not_print = 1;
sym___builtin_neon_vqshl_s_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_s_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vqshl_s_nv2si->do_not_print = 1;
sym___builtin_neon_vqshl_s_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_s_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_s_nv4hi->do_not_print = 1;
sym___builtin_neon_vqshl_s_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_s_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqshl_s_nv4si->do_not_print = 1;
sym___builtin_neon_vqshl_s_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_s_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_s_nv8hi->do_not_print = 1;
sym___builtin_neon_vqshl_s_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_s_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_s_nv8qi->do_not_print = 1;
sym___builtin_neon_vqshl_s_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqshlsv16qi->do_not_print = 1;
sym___builtin_neon_vqshlsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlsv2di->kind = SK_FUNCTION;sym___builtin_neon_vqshlsv2di->do_not_print = 1;
sym___builtin_neon_vqshlsv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vqshlsv2si->do_not_print = 1;
sym___builtin_neon_vqshlsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqshlsv4hi->do_not_print = 1;
sym___builtin_neon_vqshlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlsv4si->kind = SK_FUNCTION;sym___builtin_neon_vqshlsv4si->do_not_print = 1;
sym___builtin_neon_vqshlsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqshlsv8hi->do_not_print = 1;
sym___builtin_neon_vqshlsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqshlsv8qi->do_not_print = 1;
sym___builtin_neon_vqshlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshludi->kind = SK_FUNCTION;sym___builtin_neon_vqshludi->do_not_print = 1;
...
sym___builtin_neon_vqshl_u_ndi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_u_ndi->do_not_print = 1;
...
sym___builtin_neon_vqshlu_ndi->kind = SK_FUNCTION;sym___builtin_neon_vqshlu_ndi->do_not_print = 1;
...
sym___builtin_neon_vqshl_u_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_u_nv16qi->do_not_print = 1;
sym___builtin_neon_vqshl_u_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlu_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqshlu_nv16qi->do_not_print = 1;
sym___builtin_neon_vqshlu_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_u_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqshl_u_nv2di->do_not_print = 1;
sym___builtin_neon_vqshl_u_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlu_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqshlu_nv2di->do_not_print = 1;
sym___builtin_neon_vqshlu_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_u_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vqshl_u_nv2si->do_not_print = 1;
sym___builtin_neon_vqshl_u_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlu_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vqshlu_nv2si->do_not_print = 1;
sym___builtin_neon_vqshlu_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_u_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_u_nv4hi->do_not_print = 1;
sym___builtin_neon_vqshl_u_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlu_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqshlu_nv4hi->do_not_print = 1;
sym___builtin_neon_vqshlu_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_u_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqshl_u_nv4si->do_not_print = 1;
sym___builtin_neon_vqshl_u_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlu_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqshlu_nv4si->do_not_print = 1;
sym___builtin_neon_vqshlu_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_u_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_u_nv8hi->do_not_print = 1;
sym___builtin_neon_vqshl_u_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlu_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqshlu_nv8hi->do_not_print = 1;
sym___builtin_neon_vqshlu_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshl_u_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqshl_u_nv8qi->do_not_print = 1;
sym___builtin_neon_vqshl_u_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshlu_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqshlu_nv8qi->do_not_print = 1;
sym___builtin_neon_vqshlu_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshluv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqshluv16qi->do_not_print = 1;
sym___builtin_neon_vqshluv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshluv2di->kind = SK_FUNCTION;sym___builtin_neon_vqshluv2di->do_not_print = 1;
sym___builtin_neon_vqshluv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshluv2si->kind = SK_FUNCTION;sym___builtin_neon_vqshluv2si->do_not_print = 1;
sym___builtin_neon_vqshluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqshluv4hi->do_not_print = 1;
sym___builtin_neon_vqshluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshluv4si->kind = SK_FUNCTION;sym___builtin_neon_vqshluv4si->do_not_print = 1;
sym___builtin_neon_vqshluv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshluv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqshluv8hi->do_not_print = 1;
sym___builtin_neon_vqshluv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqshluv8qi->do_not_print = 1;
sym___builtin_neon_vqshluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrns_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqshrns_nv2di->do_not_print = 1;
sym___builtin_neon_vqshrns_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrns_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqshrns_nv4si->do_not_print = 1;
sym___builtin_neon_vqshrns_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrns_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqshrns_nv8hi->do_not_print = 1;
sym___builtin_neon_vqshrns_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrnu_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqshrnu_nv2di->do_not_print = 1;
sym___builtin_neon_vqshrnu_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrnu_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqshrnu_nv4si->do_not_print = 1;
sym___builtin_neon_vqshrnu_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrnu_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqshrnu_nv8hi->do_not_print = 1;
sym___builtin_neon_vqshrnu_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrun_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vqshrun_nv2di->do_not_print = 1;
sym___builtin_neon_vqshrun_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrun_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vqshrun_nv4si->do_not_print = 1;
sym___builtin_neon_vqshrun_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqshrun_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqshrun_nv8hi->do_not_print = 1;
sym___builtin_neon_vqshrun_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubsdi->kind = SK_FUNCTION;sym___builtin_neon_vqsubsdi->do_not_print = 1;
...
sym___builtin_neon_vqsubsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqsubsv16qi->do_not_print = 1;
sym___builtin_neon_vqsubsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubsv2di->kind = SK_FUNCTION;sym___builtin_neon_vqsubsv2di->do_not_print = 1;
sym___builtin_neon_vqsubsv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubsv2si->kind = SK_FUNCTION;sym___builtin_neon_vqsubsv2si->do_not_print = 1;
sym___builtin_neon_vqsubsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqsubsv4hi->do_not_print = 1;
sym___builtin_neon_vqsubsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubsv4si->kind = SK_FUNCTION;sym___builtin_neon_vqsubsv4si->do_not_print = 1;
sym___builtin_neon_vqsubsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqsubsv8hi->do_not_print = 1;
sym___builtin_neon_vqsubsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqsubsv8qi->do_not_print = 1;
sym___builtin_neon_vqsubsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubudi->kind = SK_FUNCTION;sym___builtin_neon_vqsubudi->do_not_print = 1;
...
sym___builtin_neon_vqsubuv16qi->kind = SK_FUNCTION;sym___builtin_neon_vqsubuv16qi->do_not_print = 1;
sym___builtin_neon_vqsubuv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubuv2di->kind = SK_FUNCTION;sym___builtin_neon_vqsubuv2di->do_not_print = 1;
sym___builtin_neon_vqsubuv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubuv2si->kind = SK_FUNCTION;sym___builtin_neon_vqsubuv2si->do_not_print = 1;
sym___builtin_neon_vqsubuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vqsubuv4hi->do_not_print = 1;
sym___builtin_neon_vqsubuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubuv4si->kind = SK_FUNCTION;sym___builtin_neon_vqsubuv4si->do_not_print = 1;
sym___builtin_neon_vqsubuv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubuv8hi->kind = SK_FUNCTION;sym___builtin_neon_vqsubuv8hi->do_not_print = 1;
sym___builtin_neon_vqsubuv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vqsubuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vqsubuv8qi->do_not_print = 1;
sym___builtin_neon_vqsubuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vraddhnv2di->kind = SK_FUNCTION;sym___builtin_neon_vraddhnv2di->do_not_print = 1;
sym___builtin_neon_vraddhnv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vraddhnv4si->kind = SK_FUNCTION;sym___builtin_neon_vraddhnv4si->do_not_print = 1;
sym___builtin_neon_vraddhnv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vraddhnv8hi->kind = SK_FUNCTION;sym___builtin_neon_vraddhnv8hi->do_not_print = 1;
sym___builtin_neon_vraddhnv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrecpev2sf->kind = SK_FUNCTION;sym___builtin_neon_vrecpev2sf->do_not_print = 1;
sym___builtin_neon_vrecpev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrecpev2si->kind = SK_FUNCTION;sym___builtin_neon_vrecpev2si->do_not_print = 1;
sym___builtin_neon_vrecpev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrecpev4sf->kind = SK_FUNCTION;sym___builtin_neon_vrecpev4sf->do_not_print = 1;
sym___builtin_neon_vrecpev4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrecpev4si->kind = SK_FUNCTION;sym___builtin_neon_vrecpev4si->do_not_print = 1;
sym___builtin_neon_vrecpev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrecpsv2sf->kind = SK_FUNCTION;sym___builtin_neon_vrecpsv2sf->do_not_print = 1;
sym___builtin_neon_vrecpsv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrecpsv4sf->kind = SK_FUNCTION;sym___builtin_neon_vrecpsv4sf->do_not_print = 1;
sym___builtin_neon_vrecpsv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vreinterpretdidi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretdidi->do_not_print = 1;
...
sym___builtin_neon_vreinterpretdiv2sf->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretdiv2sf->do_not_print = 1;
...
sym___builtin_neon_vreinterpretdiv2si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretdiv2si->do_not_print = 1;
...
sym___builtin_neon_vreinterpretdiv4hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretdiv4hi->do_not_print = 1;
...
sym___builtin_neon_vreinterpretdiv8qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretdiv8qi->do_not_print = 1;
...
sym___builtin_neon_vreinterpretv16qiv16qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv16qiv16qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv16qiv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv16qiv2di->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv16qiv2di->do_not_print = 1;
sym___builtin_neon_vreinterpretv16qiv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv16qiv4sf->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv16qiv4sf->do_not_print = 1;
sym___builtin_neon_vreinterpretv16qiv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv16qiv4si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv16qiv4si->do_not_print = 1;
sym___builtin_neon_vreinterpretv16qiv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv16qiv8hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv16qiv8hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv16qiv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2div16qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2div16qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv2div16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2div2di->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2div2di->do_not_print = 1;
sym___builtin_neon_vreinterpretv2div2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2div4sf->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2div4sf->do_not_print = 1;
sym___builtin_neon_vreinterpretv2div4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2div4si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2div4si->do_not_print = 1;
sym___builtin_neon_vreinterpretv2div4si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2div8hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2div8hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv2div8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2sfdi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2sfdi->do_not_print = 1;
sym___builtin_neon_vreinterpretv2sfdi->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2sfv2si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2sfv2si->do_not_print = 1;
sym___builtin_neon_vreinterpretv2sfv2si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2sfv4hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2sfv4hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv2sfv4hi->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2sfv8qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2sfv8qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv2sfv8qi->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2sidi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2sidi->do_not_print = 1;
sym___builtin_neon_vreinterpretv2sidi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2siv2sf->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2siv2sf->do_not_print = 1;
sym___builtin_neon_vreinterpretv2siv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2siv2si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2siv2si->do_not_print = 1;
sym___builtin_neon_vreinterpretv2siv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2siv4hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2siv4hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv2siv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv2siv8qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv2siv8qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv2siv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4hidi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4hidi->do_not_print = 1;
sym___builtin_neon_vreinterpretv4hidi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4hiv2sf->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4hiv2sf->do_not_print = 1;
sym___builtin_neon_vreinterpretv4hiv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4hiv2si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4hiv2si->do_not_print = 1;
sym___builtin_neon_vreinterpretv4hiv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4hiv4hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4hiv4hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv4hiv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4hiv8qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4hiv8qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv4hiv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4sfv16qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4sfv16qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv4sfv16qi->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4sfv2di->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4sfv2di->do_not_print = 1;
sym___builtin_neon_vreinterpretv4sfv2di->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4sfv4si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4sfv4si->do_not_print = 1;
sym___builtin_neon_vreinterpretv4sfv4si->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4sfv8hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4sfv8hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv4sfv8hi->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4siv16qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4siv16qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv4siv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4siv2di->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4siv2di->do_not_print = 1;
sym___builtin_neon_vreinterpretv4siv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4siv4sf->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4siv4sf->do_not_print = 1;
sym___builtin_neon_vreinterpretv4siv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4siv4si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4siv4si->do_not_print = 1;
sym___builtin_neon_vreinterpretv4siv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv4siv8hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv4siv8hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv4siv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8hiv16qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8hiv16qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv8hiv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8hiv2di->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8hiv2di->do_not_print = 1;
sym___builtin_neon_vreinterpretv8hiv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8hiv4sf->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8hiv4sf->do_not_print = 1;
sym___builtin_neon_vreinterpretv8hiv4sf->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8hiv4si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8hiv4si->do_not_print = 1;
sym___builtin_neon_vreinterpretv8hiv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8hiv8hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8hiv8hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv8hiv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8qidi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8qidi->do_not_print = 1;
sym___builtin_neon_vreinterpretv8qidi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8qiv2sf->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8qiv2sf->do_not_print = 1;
sym___builtin_neon_vreinterpretv8qiv2sf->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8qiv2si->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8qiv2si->do_not_print = 1;
sym___builtin_neon_vreinterpretv8qiv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8qiv4hi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8qiv4hi->do_not_print = 1;
sym___builtin_neon_vreinterpretv8qiv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vreinterpretv8qiv8qi->kind = SK_FUNCTION;sym___builtin_neon_vreinterpretv8qiv8qi->do_not_print = 1;
sym___builtin_neon_vreinterpretv8qiv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrhaddsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vrhaddsv16qi->do_not_print = 1;
sym___builtin_neon_vrhaddsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhaddsv2si->kind = SK_FUNCTION;sym___builtin_neon_vrhaddsv2si->do_not_print = 1;
sym___builtin_neon_vrhaddsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhaddsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vrhaddsv4hi->do_not_print = 1;
sym___builtin_neon_vrhaddsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhaddsv4si->kind = SK_FUNCTION;sym___builtin_neon_vrhaddsv4si->do_not_print = 1;
sym___builtin_neon_vrhaddsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhaddsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrhaddsv8hi->do_not_print = 1;
sym___builtin_neon_vrhaddsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhaddsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vrhaddsv8qi->do_not_print = 1;
sym___builtin_neon_vrhaddsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhadduv16qi->kind = SK_FUNCTION;sym___builtin_neon_vrhadduv16qi->do_not_print = 1;
sym___builtin_neon_vrhadduv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhadduv2si->kind = SK_FUNCTION;sym___builtin_neon_vrhadduv2si->do_not_print = 1;
sym___builtin_neon_vrhadduv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhadduv4hi->kind = SK_FUNCTION;sym___builtin_neon_vrhadduv4hi->do_not_print = 1;
sym___builtin_neon_vrhadduv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhadduv4si->kind = SK_FUNCTION;sym___builtin_neon_vrhadduv4si->do_not_print = 1;
sym___builtin_neon_vrhadduv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhadduv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrhadduv8hi->do_not_print = 1;
sym___builtin_neon_vrhadduv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrhadduv8qi->kind = SK_FUNCTION;sym___builtin_neon_vrhadduv8qi->do_not_print = 1;
sym___builtin_neon_vrhadduv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshlsdi->kind = SK_FUNCTION;sym___builtin_neon_vrshlsdi->do_not_print = 1;
...
sym___builtin_neon_vrshlsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vrshlsv16qi->do_not_print = 1;
sym___builtin_neon_vrshlsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshlsv2di->kind = SK_FUNCTION;sym___builtin_neon_vrshlsv2di->do_not_print = 1;
sym___builtin_neon_vrshlsv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vrshlsv2si->do_not_print = 1;
sym___builtin_neon_vrshlsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vrshlsv4hi->do_not_print = 1;
sym___builtin_neon_vrshlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshlsv4si->kind = SK_FUNCTION;sym___builtin_neon_vrshlsv4si->do_not_print = 1;
sym___builtin_neon_vrshlsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshlsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrshlsv8hi->do_not_print = 1;
sym___builtin_neon_vrshlsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vrshlsv8qi->do_not_print = 1;
sym___builtin_neon_vrshlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshludi->kind = SK_FUNCTION;sym___builtin_neon_vrshludi->do_not_print = 1;
...
sym___builtin_neon_vrshluv16qi->kind = SK_FUNCTION;sym___builtin_neon_vrshluv16qi->do_not_print = 1;
sym___builtin_neon_vrshluv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshluv2di->kind = SK_FUNCTION;sym___builtin_neon_vrshluv2di->do_not_print = 1;
sym___builtin_neon_vrshluv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshluv2si->kind = SK_FUNCTION;sym___builtin_neon_vrshluv2si->do_not_print = 1;
sym___builtin_neon_vrshluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vrshluv4hi->do_not_print = 1;
sym___builtin_neon_vrshluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshluv4si->kind = SK_FUNCTION;sym___builtin_neon_vrshluv4si->do_not_print = 1;
sym___builtin_neon_vrshluv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshluv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrshluv8hi->do_not_print = 1;
sym___builtin_neon_vrshluv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vrshluv8qi->do_not_print = 1;
sym___builtin_neon_vrshluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrn_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vrshrn_nv2di->do_not_print = 1;
sym___builtin_neon_vrshrn_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrn_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vrshrn_nv4si->do_not_print = 1;
sym___builtin_neon_vrshrn_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrn_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrshrn_nv8hi->do_not_print = 1;
sym___builtin_neon_vrshrn_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrs_ndi->kind = SK_FUNCTION;sym___builtin_neon_vrshrs_ndi->do_not_print = 1;
...
sym___builtin_neon_vrshrs_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vrshrs_nv16qi->do_not_print = 1;
sym___builtin_neon_vrshrs_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrs_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vrshrs_nv2di->do_not_print = 1;
sym___builtin_neon_vrshrs_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrs_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vrshrs_nv2si->do_not_print = 1;
sym___builtin_neon_vrshrs_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrs_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vrshrs_nv4hi->do_not_print = 1;
sym___builtin_neon_vrshrs_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrs_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vrshrs_nv4si->do_not_print = 1;
sym___builtin_neon_vrshrs_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrs_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrshrs_nv8hi->do_not_print = 1;
sym___builtin_neon_vrshrs_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshrs_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vrshrs_nv8qi->do_not_print = 1;
sym___builtin_neon_vrshrs_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshru_ndi->kind = SK_FUNCTION;sym___builtin_neon_vrshru_ndi->do_not_print = 1;
...
sym___builtin_neon_vrshru_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vrshru_nv16qi->do_not_print = 1;
sym___builtin_neon_vrshru_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshru_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vrshru_nv2di->do_not_print = 1;
sym___builtin_neon_vrshru_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshru_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vrshru_nv2si->do_not_print = 1;
sym___builtin_neon_vrshru_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshru_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vrshru_nv4hi->do_not_print = 1;
sym___builtin_neon_vrshru_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshru_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vrshru_nv4si->do_not_print = 1;
sym___builtin_neon_vrshru_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshru_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrshru_nv8hi->do_not_print = 1;
sym___builtin_neon_vrshru_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrshru_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vrshru_nv8qi->do_not_print = 1;
sym___builtin_neon_vrshru_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrsqrtev2sf->kind = SK_FUNCTION;sym___builtin_neon_vrsqrtev2sf->do_not_print = 1;
sym___builtin_neon_vrsqrtev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrsqrtev2si->kind = SK_FUNCTION;sym___builtin_neon_vrsqrtev2si->do_not_print = 1;
sym___builtin_neon_vrsqrtev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrsqrtev4sf->kind = SK_FUNCTION;sym___builtin_neon_vrsqrtev4sf->do_not_print = 1;
sym___builtin_neon_vrsqrtev4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrsqrtev4si->kind = SK_FUNCTION;sym___builtin_neon_vrsqrtev4si->do_not_print = 1;
sym___builtin_neon_vrsqrtev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[1]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
;
...
sym___builtin_neon_vrsqrtsv2sf->kind = SK_FUNCTION;sym___builtin_neon_vrsqrtsv2sf->do_not_print = 1;
sym___builtin_neon_vrsqrtsv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrsqrtsv4sf->kind = SK_FUNCTION;sym___builtin_neon_vrsqrtsv4sf->do_not_print = 1;
sym___builtin_neon_vrsqrtsv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrsras_ndi->kind = SK_FUNCTION;sym___builtin_neon_vrsras_ndi->do_not_print = 1;
...
sym___builtin_neon_vrsras_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vrsras_nv16qi->do_not_print = 1;
sym___builtin_neon_vrsras_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsras_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vrsras_nv2di->do_not_print = 1;
sym___builtin_neon_vrsras_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsras_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vrsras_nv2si->do_not_print = 1;
sym___builtin_neon_vrsras_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsras_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vrsras_nv4hi->do_not_print = 1;
sym___builtin_neon_vrsras_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsras_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vrsras_nv4si->do_not_print = 1;
sym___builtin_neon_vrsras_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsras_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrsras_nv8hi->do_not_print = 1;
sym___builtin_neon_vrsras_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsras_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vrsras_nv8qi->do_not_print = 1;
sym___builtin_neon_vrsras_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsrau_ndi->kind = SK_FUNCTION;sym___builtin_neon_vrsrau_ndi->do_not_print = 1;
...
sym___builtin_neon_vrsrau_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vrsrau_nv16qi->do_not_print = 1;
sym___builtin_neon_vrsrau_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsrau_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vrsrau_nv2di->do_not_print = 1;
sym___builtin_neon_vrsrau_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsrau_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vrsrau_nv2si->do_not_print = 1;
sym___builtin_neon_vrsrau_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsrau_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vrsrau_nv4hi->do_not_print = 1;
sym___builtin_neon_vrsrau_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsrau_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vrsrau_nv4si->do_not_print = 1;
sym___builtin_neon_vrsrau_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsrau_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrsrau_nv8hi->do_not_print = 1;
sym___builtin_neon_vrsrau_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsrau_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vrsrau_nv8qi->do_not_print = 1;
sym___builtin_neon_vrsrau_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vrsubhnv2di->kind = SK_FUNCTION;sym___builtin_neon_vrsubhnv2di->do_not_print = 1;
sym___builtin_neon_vrsubhnv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrsubhnv4si->kind = SK_FUNCTION;sym___builtin_neon_vrsubhnv4si->do_not_print = 1;
sym___builtin_neon_vrsubhnv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vrsubhnv8hi->kind = SK_FUNCTION;sym___builtin_neon_vrsubhnv8hi->do_not_print = 1;
sym___builtin_neon_vrsubhnv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vset_lanedi->kind = SK_FUNCTION;sym___builtin_neon_vset_lanedi->do_not_print = 1;
...
sym___builtin_neon_vset_lanev16qi->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev16qi->do_not_print = 1;
sym___builtin_neon_vset_lanev16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
...
sym___builtin_neon_vset_lanev2di->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev2di->do_not_print = 1;
sym___builtin_neon_vset_lanev2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_long_long_int_type();
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vset_lanev2sf->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev2sf->do_not_print = 1;
sym___builtin_neon_vset_lanev2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
...
sym___builtin_neon_vset_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev2si->do_not_print = 1;
sym___builtin_neon_vset_lanev2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
...
sym___builtin_neon_vset_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev4hi->do_not_print = 1;
sym___builtin_neon_vset_lanev4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
...
sym___builtin_neon_vset_lanev4sf->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev4sf->do_not_print = 1;
sym___builtin_neon_vset_lanev4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_float_type();
p[1].type_info = get_vector_type(get_float_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vset_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev4si->do_not_print = 1;
sym___builtin_neon_vset_lanev4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_int_type();
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vset_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev8hi->do_not_print = 1;
sym___builtin_neon_vset_lanev8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_short_int_type();
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vset_lanev8qi->kind = SK_FUNCTION;sym___builtin_neon_vset_lanev8qi->do_not_print = 1;
sym___builtin_neon_vset_lanev8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_signed_char_type();
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vshlls_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vshlls_nv2si->do_not_print = 1;
sym___builtin_neon_vshlls_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlls_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vshlls_nv4hi->do_not_print = 1;
sym___builtin_neon_vshlls_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlls_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vshlls_nv8qi->do_not_print = 1;
sym___builtin_neon_vshlls_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshllu_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vshllu_nv2si->do_not_print = 1;
sym___builtin_neon_vshllu_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshllu_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vshllu_nv4hi->do_not_print = 1;
sym___builtin_neon_vshllu_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshllu_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vshllu_nv8qi->do_not_print = 1;
sym___builtin_neon_vshllu_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshl_ndi->kind = SK_FUNCTION;sym___builtin_neon_vshl_ndi->do_not_print = 1;
...
sym___builtin_neon_vshl_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vshl_nv16qi->do_not_print = 1;
sym___builtin_neon_vshl_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshl_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vshl_nv2di->do_not_print = 1;
sym___builtin_neon_vshl_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshl_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vshl_nv2si->do_not_print = 1;
sym___builtin_neon_vshl_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshl_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vshl_nv4hi->do_not_print = 1;
sym___builtin_neon_vshl_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshl_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vshl_nv4si->do_not_print = 1;
sym___builtin_neon_vshl_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshl_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vshl_nv8hi->do_not_print = 1;
sym___builtin_neon_vshl_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshl_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vshl_nv8qi->do_not_print = 1;
sym___builtin_neon_vshl_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlsdi->kind = SK_FUNCTION;sym___builtin_neon_vshlsdi->do_not_print = 1;
...
sym___builtin_neon_vshlsv16qi->kind = SK_FUNCTION;sym___builtin_neon_vshlsv16qi->do_not_print = 1;
sym___builtin_neon_vshlsv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlsv2di->kind = SK_FUNCTION;sym___builtin_neon_vshlsv2di->do_not_print = 1;
sym___builtin_neon_vshlsv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlsv2si->kind = SK_FUNCTION;sym___builtin_neon_vshlsv2si->do_not_print = 1;
sym___builtin_neon_vshlsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vshlsv4hi->do_not_print = 1;
sym___builtin_neon_vshlsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlsv4si->kind = SK_FUNCTION;sym___builtin_neon_vshlsv4si->do_not_print = 1;
sym___builtin_neon_vshlsv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlsv8hi->kind = SK_FUNCTION;sym___builtin_neon_vshlsv8hi->do_not_print = 1;
sym___builtin_neon_vshlsv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshlsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vshlsv8qi->do_not_print = 1;
sym___builtin_neon_vshlsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshludi->kind = SK_FUNCTION;sym___builtin_neon_vshludi->do_not_print = 1;
...
sym___builtin_neon_vshluv16qi->kind = SK_FUNCTION;sym___builtin_neon_vshluv16qi->do_not_print = 1;
sym___builtin_neon_vshluv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshluv2di->kind = SK_FUNCTION;sym___builtin_neon_vshluv2di->do_not_print = 1;
sym___builtin_neon_vshluv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshluv2si->kind = SK_FUNCTION;sym___builtin_neon_vshluv2si->do_not_print = 1;
sym___builtin_neon_vshluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vshluv4hi->do_not_print = 1;
sym___builtin_neon_vshluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshluv4si->kind = SK_FUNCTION;sym___builtin_neon_vshluv4si->do_not_print = 1;
sym___builtin_neon_vshluv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshluv8hi->kind = SK_FUNCTION;sym___builtin_neon_vshluv8hi->do_not_print = 1;
sym___builtin_neon_vshluv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vshluv8qi->do_not_print = 1;
sym___builtin_neon_vshluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrn_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vshrn_nv2di->do_not_print = 1;
sym___builtin_neon_vshrn_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrn_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vshrn_nv4si->do_not_print = 1;
sym___builtin_neon_vshrn_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrn_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vshrn_nv8hi->do_not_print = 1;
sym___builtin_neon_vshrn_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrs_ndi->kind = SK_FUNCTION;sym___builtin_neon_vshrs_ndi->do_not_print = 1;
...
sym___builtin_neon_vshrs_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vshrs_nv16qi->do_not_print = 1;
sym___builtin_neon_vshrs_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrs_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vshrs_nv2di->do_not_print = 1;
sym___builtin_neon_vshrs_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrs_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vshrs_nv2si->do_not_print = 1;
sym___builtin_neon_vshrs_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrs_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vshrs_nv4hi->do_not_print = 1;
sym___builtin_neon_vshrs_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrs_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vshrs_nv4si->do_not_print = 1;
sym___builtin_neon_vshrs_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrs_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vshrs_nv8hi->do_not_print = 1;
sym___builtin_neon_vshrs_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshrs_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vshrs_nv8qi->do_not_print = 1;
sym___builtin_neon_vshrs_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshru_ndi->kind = SK_FUNCTION;sym___builtin_neon_vshru_ndi->do_not_print = 1;
...
sym___builtin_neon_vshru_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vshru_nv16qi->do_not_print = 1;
sym___builtin_neon_vshru_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshru_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vshru_nv2di->do_not_print = 1;
sym___builtin_neon_vshru_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshru_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vshru_nv2si->do_not_print = 1;
sym___builtin_neon_vshru_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshru_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vshru_nv4hi->do_not_print = 1;
sym___builtin_neon_vshru_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshru_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vshru_nv4si->do_not_print = 1;
sym___builtin_neon_vshru_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshru_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vshru_nv8hi->do_not_print = 1;
sym___builtin_neon_vshru_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vshru_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vshru_nv8qi->do_not_print = 1;
sym___builtin_neon_vshru_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsli_ndi->kind = SK_FUNCTION;sym___builtin_neon_vsli_ndi->do_not_print = 1;
...
sym___builtin_neon_vsli_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vsli_nv16qi->do_not_print = 1;
sym___builtin_neon_vsli_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsli_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vsli_nv2di->do_not_print = 1;
sym___builtin_neon_vsli_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsli_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vsli_nv2si->do_not_print = 1;
sym___builtin_neon_vsli_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsli_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vsli_nv4hi->do_not_print = 1;
sym___builtin_neon_vsli_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsli_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vsli_nv4si->do_not_print = 1;
sym___builtin_neon_vsli_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsli_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vsli_nv8hi->do_not_print = 1;
sym___builtin_neon_vsli_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsli_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vsli_nv8qi->do_not_print = 1;
sym___builtin_neon_vsli_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsras_ndi->kind = SK_FUNCTION;sym___builtin_neon_vsras_ndi->do_not_print = 1;
...
sym___builtin_neon_vsras_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vsras_nv16qi->do_not_print = 1;
sym___builtin_neon_vsras_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsras_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vsras_nv2di->do_not_print = 1;
sym___builtin_neon_vsras_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsras_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vsras_nv2si->do_not_print = 1;
sym___builtin_neon_vsras_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsras_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vsras_nv4hi->do_not_print = 1;
sym___builtin_neon_vsras_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsras_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vsras_nv4si->do_not_print = 1;
sym___builtin_neon_vsras_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsras_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vsras_nv8hi->do_not_print = 1;
sym___builtin_neon_vsras_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsras_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vsras_nv8qi->do_not_print = 1;
sym___builtin_neon_vsras_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsrau_ndi->kind = SK_FUNCTION;sym___builtin_neon_vsrau_ndi->do_not_print = 1;
...
sym___builtin_neon_vsrau_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vsrau_nv16qi->do_not_print = 1;
sym___builtin_neon_vsrau_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsrau_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vsrau_nv2di->do_not_print = 1;
sym___builtin_neon_vsrau_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsrau_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vsrau_nv2si->do_not_print = 1;
sym___builtin_neon_vsrau_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsrau_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vsrau_nv4hi->do_not_print = 1;
sym___builtin_neon_vsrau_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsrau_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vsrau_nv4si->do_not_print = 1;
sym___builtin_neon_vsrau_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsrau_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vsrau_nv8hi->do_not_print = 1;
sym___builtin_neon_vsrau_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsrau_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vsrau_nv8qi->do_not_print = 1;
sym___builtin_neon_vsrau_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsri_ndi->kind = SK_FUNCTION;sym___builtin_neon_vsri_ndi->do_not_print = 1;
...
sym___builtin_neon_vsri_nv16qi->kind = SK_FUNCTION;sym___builtin_neon_vsri_nv16qi->do_not_print = 1;
sym___builtin_neon_vsri_nv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsri_nv2di->kind = SK_FUNCTION;sym___builtin_neon_vsri_nv2di->do_not_print = 1;
sym___builtin_neon_vsri_nv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsri_nv2si->kind = SK_FUNCTION;sym___builtin_neon_vsri_nv2si->do_not_print = 1;
sym___builtin_neon_vsri_nv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsri_nv4hi->kind = SK_FUNCTION;sym___builtin_neon_vsri_nv4hi->do_not_print = 1;
sym___builtin_neon_vsri_nv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsri_nv4si->kind = SK_FUNCTION;sym___builtin_neon_vsri_nv4si->do_not_print = 1;
sym___builtin_neon_vsri_nv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsri_nv8hi->kind = SK_FUNCTION;sym___builtin_neon_vsri_nv8hi->do_not_print = 1;
sym___builtin_neon_vsri_nv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vsri_nv8qi->kind = SK_FUNCTION;sym___builtin_neon_vsri_nv8qi->do_not_print = 1;
sym___builtin_neon_vsri_nv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_signed_int_type();
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vst1di->kind = SK_FUNCTION;sym___builtin_neon_vst1di->do_not_print = 1;
...
sym___builtin_neon_vst1_lanedi->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanedi->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev16qi->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev16qi->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev2di->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev2di->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev2sf->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev2sf->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev2si->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev2si->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev4hi->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev4hi->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev4sf->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev4sf->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev4si->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev4si->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev8hi->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev8hi->do_not_print = 1;
...
sym___builtin_neon_vst1_lanev8qi->kind = SK_FUNCTION;sym___builtin_neon_vst1_lanev8qi->do_not_print = 1;
...
sym___builtin_neon_vst1v16qi->kind = SK_FUNCTION;sym___builtin_neon_vst1v16qi->do_not_print = 1;
...
sym___builtin_neon_vst1v2di->kind = SK_FUNCTION;sym___builtin_neon_vst1v2di->do_not_print = 1;
...
sym___builtin_neon_vst1v2sf->kind = SK_FUNCTION;sym___builtin_neon_vst1v2sf->do_not_print = 1;
...
sym___builtin_neon_vst1v2si->kind = SK_FUNCTION;sym___builtin_neon_vst1v2si->do_not_print = 1;
...
sym___builtin_neon_vst1v4hi->kind = SK_FUNCTION;sym___builtin_neon_vst1v4hi->do_not_print = 1;
...
sym___builtin_neon_vst1v4sf->kind = SK_FUNCTION;sym___builtin_neon_vst1v4sf->do_not_print = 1;
...
sym___builtin_neon_vst1v4si->kind = SK_FUNCTION;sym___builtin_neon_vst1v4si->do_not_print = 1;
...
sym___builtin_neon_vst1v8hi->kind = SK_FUNCTION;sym___builtin_neon_vst1v8hi->do_not_print = 1;
...
sym___builtin_neon_vst1v8qi->kind = SK_FUNCTION;sym___builtin_neon_vst1v8qi->do_not_print = 1;
...
sym___builtin_neon_vsubhnv2di->kind = SK_FUNCTION;sym___builtin_neon_vsubhnv2di->do_not_print = 1;
sym___builtin_neon_vsubhnv2di->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubhnv4si->kind = SK_FUNCTION;sym___builtin_neon_vsubhnv4si->do_not_print = 1;
sym___builtin_neon_vsubhnv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubhnv8hi->kind = SK_FUNCTION;sym___builtin_neon_vsubhnv8hi->do_not_print = 1;
sym___builtin_neon_vsubhnv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsublsv2si->kind = SK_FUNCTION;sym___builtin_neon_vsublsv2si->do_not_print = 1;
sym___builtin_neon_vsublsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsublsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vsublsv4hi->do_not_print = 1;
sym___builtin_neon_vsublsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsublsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vsublsv8qi->do_not_print = 1;
sym___builtin_neon_vsublsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubluv2si->kind = SK_FUNCTION;sym___builtin_neon_vsubluv2si->do_not_print = 1;
sym___builtin_neon_vsubluv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubluv4hi->kind = SK_FUNCTION;sym___builtin_neon_vsubluv4hi->do_not_print = 1;
sym___builtin_neon_vsubluv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubluv8qi->kind = SK_FUNCTION;sym___builtin_neon_vsubluv8qi->do_not_print = 1;
sym___builtin_neon_vsubluv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubv2sf->kind = SK_FUNCTION;sym___builtin_neon_vsubv2sf->do_not_print = 1;
sym___builtin_neon_vsubv2sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 8);
p[1].type_info = get_vector_type(get_float_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubv4sf->kind = SK_FUNCTION;sym___builtin_neon_vsubv4sf->do_not_print = 1;
sym___builtin_neon_vsubv4sf->type_information = ({type_t* return_type = get_vector_type(get_float_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_float_type(), 16);
p[1].type_info = get_vector_type(get_float_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubwsv2si->kind = SK_FUNCTION;sym___builtin_neon_vsubwsv2si->do_not_print = 1;
sym___builtin_neon_vsubwsv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubwsv4hi->kind = SK_FUNCTION;sym___builtin_neon_vsubwsv4hi->do_not_print = 1;
sym___builtin_neon_vsubwsv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubwsv8qi->kind = SK_FUNCTION;sym___builtin_neon_vsubwsv8qi->do_not_print = 1;
sym___builtin_neon_vsubwsv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubwuv2si->kind = SK_FUNCTION;sym___builtin_neon_vsubwuv2si->do_not_print = 1;
sym___builtin_neon_vsubwuv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_long_long_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_long_long_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubwuv4hi->kind = SK_FUNCTION;sym___builtin_neon_vsubwuv4hi->do_not_print = 1;
sym___builtin_neon_vsubwuv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vsubwuv8qi->kind = SK_FUNCTION;sym___builtin_neon_vsubwuv8qi->do_not_print = 1;
sym___builtin_neon_vsubwuv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vtbl1v8qi->kind = SK_FUNCTION;sym___builtin_neon_vtbl1v8qi->do_not_print = 1;
sym___builtin_neon_vtbl1v8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vtbx1v8qi->kind = SK_FUNCTION;sym___builtin_neon_vtbx1v8qi->do_not_print = 1;
sym___builtin_neon_vtbx1v8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[3]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
p[2].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
...
sym___builtin_neon_vtstv16qi->kind = SK_FUNCTION;sym___builtin_neon_vtstv16qi->do_not_print = 1;
sym___builtin_neon_vtstv16qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 16);
p[1].type_info = get_vector_type(get_signed_char_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vtstv2si->kind = SK_FUNCTION;sym___builtin_neon_vtstv2si->do_not_print = 1;
sym___builtin_neon_vtstv2si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vtstv4hi->kind = SK_FUNCTION;sym___builtin_neon_vtstv4hi->do_not_print = 1;
sym___builtin_neon_vtstv4hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 8);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vtstv4si->kind = SK_FUNCTION;sym___builtin_neon_vtstv4si->do_not_print = 1;
sym___builtin_neon_vtstv4si->type_information = ({type_t* return_type = get_vector_type(get_signed_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vtstv8hi->kind = SK_FUNCTION;sym___builtin_neon_vtstv8hi->do_not_print = 1;
sym___builtin_neon_vtstv8hi->type_information = ({type_t* return_type = get_vector_type(get_signed_short_int_type(), 16);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_short_int_type(), 16);
p[1].type_info = get_vector_type(get_signed_short_int_type(), 16);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
...
sym___builtin_neon_vtstv8qi->kind = SK_FUNCTION;sym___builtin_neon_vtstv8qi->do_not_print = 1;
sym___builtin_neon_vtstv8qi->type_information = ({type_t* return_type = get_vector_type(get_signed_char_type(), 8);
parameter_info_t p[2]; memset(p, 0, sizeof(p));p[0].type_info = get_vector_type(get_signed_char_type(), 8);
p[1].type_info = get_vector_type(get_signed_char_type(), 8);
get_new_function_type(return_type, p, sizeof(p)/sizeof(p[0]), REF_QUALIFIER_NONE);
})
