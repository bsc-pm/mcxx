...
FORTRAN_GENERIC_INTRINSIC(bit_size, "I", I, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(digits, "X", I, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(epsilon, "X", I, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(huge, "X", I, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(int, "A,?KIND", E, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(kind, "X", I, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(len, "STRING,?KIND", I, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(maxexponent, "X", I, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(minexponent, "X", I, NULL) \
...
FORTRAN_GENERIC_INTRINSIC(tiny, "X", I, NULL) \
