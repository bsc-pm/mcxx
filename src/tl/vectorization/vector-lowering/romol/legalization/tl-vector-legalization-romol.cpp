...
namespace TL { namespace Vectorization {
    ...
    RomolVectorLegalization::RomolVectorLegalization()
    {
        std::cerr << "--- RoMoL legalization phase ---" << std::endl;

    }

    void RomolVectorLegalization::visit(const Nodecl::FunctionCode& n)
    {
        ...
        bool contains_vector_nodes =
            ...
            Nodecl::Utils::nodecl_contains_nodecl_of_kind<Nodecl::VectorMaskAnd2Not>(n) ||
            Nodecl::Utils::nodecl_contains_nodecl_of_kind<Nodecl::VectorMaskAnd1Not>(n)
            ;
    ...
    void RomolVectorLegalization::visit(const Nodecl::ObjectInit& n)
    {
    ...
    void RomolVectorLegalization::visit(const Nodecl::VectorConversion& n)
    {
        walk(n.get_nest());

    }

    void RomolVectorLegalization::visit(const Nodecl::VectorAssignment& n)
    {
    ...
    void RomolVectorLegalization::visit(const Nodecl::VectorLoad& n)
    {
    ...
    void RomolVectorLegalization::visit(
    ...
    void RomolVectorLegalization::visit(const Nodecl::VectorMaskAnd1Not& n)
    {
        walk(n.get_lhs());
        walk(n.get_rhs());
    ...
    void RomolVectorLegalization::visit(const Nodecl::VectorMaskAnd2Not& n)
    {
        walk(n.get_lhs());
        walk(n.get_rhs());
