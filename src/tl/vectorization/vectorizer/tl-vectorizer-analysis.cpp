...
namespace Vectorization
{
    ...
    bool VectorizerAnalysisStaticInfo::is_nested_induction_variable_dependent_access(
            const VectorizerEnvironment& environment,
            const Nodecl::NodeclBase& n)
    {
        for(std::reverse_iterator<stdlist_nodecl_t::const_iterator> current_scope(
                    environment._analysis_scopes.end());
                current_scope != std::reverse_iterator<stdlist_nodecl_t::const_iterator>(
    ...
    bool VectorizerAnalysisStaticInfo::is_nested_non_reduction_basic_induction_variable(
            const VectorizerEnvironment& environment,
            const Nodecl::NodeclBase& n)
    {
    ...
    bool VectorizerAnalysisStaticInfo::loop_control_depends_on_simd_iv(
