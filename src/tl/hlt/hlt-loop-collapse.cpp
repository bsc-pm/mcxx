...
namespace TL { namespace HLT {
    ...
    void LoopCollapse::compute_collapse_statements(
            int collapse_factor,
    ...
    void LoopCollapse::compute_loop_information(
    ...
    void LoopCollapse::collapse()
    {
        ...
        TL::Symbol induction_var = loop_control_scope.new_symbol("collapse_it");
        symbol_entity_specs_set_is_user_declared(induction_var.get_internal_symbol(), 1);
        induction_var.get_internal_symbol()->kind = SK_VARIABLE;
        ...
        compute_collapse_statements(
                ...
                collapse_statements, loop_statements, condition_bound);
        ...
        if (IS_C_LANGUAGE || IS_CXX_LANGUAGE)
        {
            Nodecl::NodeclBase initialization =
                Nodecl::ObjectInit::make(induction_var);
