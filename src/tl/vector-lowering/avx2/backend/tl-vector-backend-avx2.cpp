...
*/
        ...
        void AVX2VectorLowering::visit(const Nodecl::VectorCast& node) 
        {
            ...
            {
                fprintf(stderr, "AVX2 Lowering: Casting at '%s' is not supported yet: %s\n", 
                        locus_to_str(node.get_locus()),
...
*/
        ...
        void AVX2VectorLowering::visit(const Nodecl::VectorFabs& node) 
        {
            ...
            if (type.is_float()) 
            { 
                intrin_src << "_mm512_castsi512_ps(" << AVX2_INTRIN_PREFIX << mask_prefix << "_and_epi32("
                    << mask_args  
                    << "_mm512_castps_si512("
            ...
            { 
                intrin_src << "_mm512_castsi512_pd(" << AVX2_INTRIN_PREFIX << mask_prefix << "_and_epi64("
                    << mask_args
                    << "_mm512_castpd_si512("
                    << as_expression(argument)
