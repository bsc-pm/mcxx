...
namespace TL { namespace Acotes {
    ...
    private:
        Task(const std::string& name, int num);
...
#define TASKDEVICE_SPU 1
#define TASKDEVICE_PPU 0

    private:
        int taskdevice;

    public:
        int getTaskDevice() { return taskdevice; }
        void setTaskDevice(int dev) { taskdevice = dev; }
