...
namespace TL 
{
    namespace Vectorization
    {
        VectorizerEnvironment::VectorizerEnvironment(const std::string& device,
           ...
           _target_type(target_type), _suitable_expr_list(suitable_expr_list), _nontemporal_expr_list(nontemporal_expr_list),
           _vectorizer_cache(vectorizer_cache), _reduction_list(reduction_list),
