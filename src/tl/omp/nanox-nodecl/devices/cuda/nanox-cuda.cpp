        ...
        Nodecl::Utils::SymbolMap* &symbol_map)
{
	...
	device_outline_name
		<< cuda_outline_name(outline_name)
		;

    // Outline_info is device_outline_info
};
...
{
    std::string outline_name = cuda_outline_name(info._outline_name);
    ...
    device_descriptor
        << "{ nanos_gpu_factory, &" << outline_name << "_args },"
        ;
}
