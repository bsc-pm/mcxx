...
namespace TL
{
    namespace OpenMP
    {
        void Base::common_target_handler_pre(TL::PragmaCustomLine pragma_line, TargetContext& target_ctx)
        {
        ...
        void Base::target_handler_pre(TL::PragmaCustomDeclaration ctr)
        {
        ...
        void Base::target_handler_pre(TL::PragmaCustomStatement ctr)
        {
            PragmaCustomLine pragma_line = ctr.get_pragma_line();
            TargetContext target_ctx;
        ...
        void Base::get_target_info(TL::PragmaCustomLine construct, DataSharingEnvironment& data_sharing)
        {
            if (_target_context.empty())
                return;
