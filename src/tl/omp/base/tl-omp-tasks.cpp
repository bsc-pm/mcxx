...
namespace TL
{
    namespace OpenMP
    {
        ...
        void Base::task_function_handler_pre(TL::PragmaCustomDeclaration construct)
        {
        ...
        void Base::task_inline_handler_pre(TL::PragmaCustomStatement construct)
        {
            TL::PragmaCustomLine pragma_line = construct.get_pragma_line();
        ...
        RealTimeInfo Base::task_real_time_handler_pre(TL::PragmaCustomLine construct)
        {
