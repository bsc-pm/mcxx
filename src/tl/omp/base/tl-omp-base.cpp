...
namespace TL
{
    namespace OpenMP
    {
        ...
        {
            set_phase_name("OpenMP Base Analysis");
...
#undef OMP_CONSTRUCT_NOEND
        ...
        void Base::get_clause_symbols(PragmaCustomClause clause, 
        ...
        void Base::get_data_explicit_attributes(TL::PragmaCustomLine construct, 
                DataSharingEnvironment& data_sharing)
        {
        ...
        DataSharingAttribute Base::get_default_data_sharing(TL::PragmaCustomLine construct,
        ...
        void Base::get_data_implicit_attributes(TL::PragmaCustomStatement construct, 
        ...
        void Base::common_parallel_handler(TL::PragmaCustomStatement construct, DataSharingEnvironment& data_sharing)
        {
        ...
        void Base::common_sections_handler(TL::PragmaCustomStatement construct, const std::string& pragma_name)
        {
        ...
        void Base::fix_first_section(TL::PragmaCustomStatement construct)
        {
            Nodecl::NodeclBase stmt = construct.get_statements();
        ...
        void Base::common_for_handler(TL::PragmaCustomStatement construct, DataSharingEnvironment& data_sharing)
        {
            Nodecl::NodeclBase stmt = construct.get_statements();
        ...
        void Base::common_workshare_handler(TL::PragmaCustomStatement construct, DataSharingEnvironment& data_sharing)
        {
            TL::PragmaCustomLine pragma_line = construct.get_pragma_line();
        ...
        void Base::get_data_implicit_attributes_task(TL::PragmaCustomStatement construct,
                DataSharingEnvironment& data_sharing,
                DataSharingAttribute default_data_attr)
        {
            Nodecl::NodeclBase statement = construct.get_statements();
        ...
        // Handlers
        void Base::parallel_handler_pre(TL::PragmaCustomStatement construct)
        {
        ...
        void Base::parallel_handler_post(TL::PragmaCustomStatement construct)
        {
            _openmp_info->pop_current_data_sharing();
        }

        void Base::parallel_for_handler_pre(TL::PragmaCustomStatement construct)
        {
            DataSharingEnvironment& data_sharing = _openmp_info->get_new_data_sharing(construct);
        ...
        void Base::parallel_for_handler_post(TL::PragmaCustomStatement construct)
        {
            _openmp_info->pop_current_data_sharing();
        }

        void Base::for_handler_pre(TL::PragmaCustomStatement construct)
        {
            DataSharingEnvironment& data_sharing = _openmp_info->get_new_data_sharing(construct);
        ...
        void Base::for_handler_post(TL::PragmaCustomStatement construct)
        {
            _openmp_info->pop_current_data_sharing();
        }

        void Base::single_handler_pre(TL::PragmaCustomStatement construct)
        {
            DataSharingEnvironment& data_sharing = _openmp_info->get_new_data_sharing(construct);
            _openmp_info->push_current_data_sharing(data_sharing);
            common_workshare_handler(construct, data_sharing);
        ...
        void Base::single_handler_post(TL::PragmaCustomStatement construct)
        {
            _openmp_info->pop_current_data_sharing();
        }

        void Base::parallel_sections_handler_pre(TL::PragmaCustomStatement construct)
        {
            DataSharingEnvironment& data_sharing = _openmp_info->get_new_data_sharing(construct);
            _openmp_info->push_current_data_sharing(data_sharing);
            common_parallel_handler(construct, data_sharing);
        ...
        void Base::parallel_sections_handler_post(TL::PragmaCustomStatement construct)
        {
            fix_first_section(construct);
            _openmp_info->pop_current_data_sharing();
        }

        void Base::threadprivate_handler_pre(TL::PragmaCustomDirective construct)
        {
        ...
        void Base::threadprivate_handler_post(TL::PragmaCustomDirective construct) { }
        ...
        void Base::task_handler_pre(TL::PragmaCustomDeclaration construct)
        {
            // task_function_handler_pre(construct);
        }

        void Base::task_handler_post(TL::PragmaCustomStatement construct)
        {
            _openmp_info->pop_current_data_sharing();
        }

        void Base::task_handler_post(TL::PragmaCustomDeclaration construct)
        {
            // Do nothing
        }

        void Base::taskwait_handler_pre(TL::PragmaCustomDirective construct)
        {
            DataSharingEnvironment& data_sharing = _openmp_info->get_new_data_sharing(construct);
            _openmp_info->push_current_data_sharing(data_sharing);
        ...
        void Base::taskwait_handler_post(TL::PragmaCustomDirective construct)
        {
            _openmp_info->pop_current_data_sharing();
        }

        void Base::sections_handler_pre(TL::PragmaCustomStatement construct)
        {
            DataSharingEnvironment& data_sharing = _openmp_info->get_new_data_sharing(construct);
            _openmp_info->push_current_data_sharing(data_sharing);
        ...
        void Base::sections_handler_post(TL::PragmaCustomStatement construct)
        {
            fix_first_section(construct);
            _openmp_info->pop_current_data_sharing();
        }

        void Base::declare_reduction_handler_pre(TL::PragmaCustomDirective directive)
        {
        }
