...
#ifndef TL_OMP_SIMD_IR_VISITOR_STATEMENT_HPP
#define TL_OMP_SIMD_IR_VISITOR_STATEMENT_HPP
...
{ 
    namespace SIMD 
    {
        class SimdIRVisitorStatement : public Nodecl::NodeclVisitor<void>
        {
            public:
...
#endif //TL_OMP_SIMD_IR_VISITOR_STATEMENT_HPP
