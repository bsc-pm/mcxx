...
#ifndef TL_SIMD_FUNCTIONS_HPP
#define TL_SIMD_FUNCTIONS_HPP
        ...
        */
        ...
        class SpecificFunctionInfo
        {
            private:
                ...
                TL::Symbol _arch_default_symbol;
...
/*
                ...
                Source get_definition(
                        ...
                        const TL::Symbol& generic_func_sym,
                        ReplaceSrcGenericFunction& replace) const;
                Source get_declaration(
                        const TL::Symbol& scalar_func_sym,
                        const TL::Symbol& generic_func_sym) const;
        ...
        {
            protected:
                const TL::Symbol _scalar_func_sym;
                Nodecl::FunctionCode _simd_func_code;

                device_specific_map_t _specific_functions;

            public:
                GenericFunctionInfo(const TL::Symbol& scalar_func_sym);
                GenericFunctionInfo(const TL::Symbol& scalar_func_sym, 
                        const Nodecl::FunctionCode& simd_func_code);

                bool has_simd_function_code();
                void set_simd_function_code(const Nodecl::FunctionCode& simd_func_code);
/*
        ...
        {
            private:
                typedef std::map<TL::Symbol, GenericFunctionInfo> function_map_t;
                function_map_t _function_map;

            public:
                GenericFunctions() : _function_map() {}

                void add_naive_generic_function(const TL::Symbol& scalar_func_sym);
                void add_simd_generic_function(const TL::Symbol& scalar_func_sym,
                        const Nodecl::FunctionCode& simd_func_code);
...
/*
        ...
        class ForStatementInfo : public TL::Object
        {
            private:
                int _min_expr_size;
                TL::TL::Symbol _ind_var_sym;
                ObjectList<TL::Symbol> _nonlocal_symbols;
                bool _is_valid;
            ...
            public:
                ...
                TL::Symbol get_ind_var_sym();
                ObjectList<TL::Symbol> get_nonlocal_symbols();
                bool is_valid();
        };
        */ 
