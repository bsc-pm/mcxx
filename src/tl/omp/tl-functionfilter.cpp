...
namespace TL
{
    void FunctionFilterFile::init(const std::string& filter_file_name, const std::string& filter_mode_var)
    {
    ...
    bool FunctionFilterFile::match(const std::string& function_name)
    {
        bool found = false;
