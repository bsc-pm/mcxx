...
namespace Analysis {
    ...
    public:
        ...
        //! Overloaded method to perform Constant Propagation Analysis in a set of PCFGs separately
        void conditional_constant_propagation( ObjectList<ExtensibleGraph*> pcfgs );
    };
