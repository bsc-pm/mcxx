...
namespace TL
{
    namespace Analysis
    {
        static bool is_loop_invariant_(Node* node, int id_end);
...
/*                        if ( it->walk() )
        ...
        LoopAnalysis::Ret LoopAnalysis::visit(const Nodecl::Derreference& n)
        {
        ...
        LoopAnalysis::Ret LoopAnalysis::visit(const Nodecl::ShlAssignment& n)
        {
            return visit_assignment(n.get_lhs(), n.get_rhs());
        }
