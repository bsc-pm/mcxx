...
//                             }
    ...
    bool AnalysisStaticInfo::is_constant(const NBase& scope, const NBase& n) const
    {
        bool result = false;
    ...
    bool AnalysisStaticInfo::is_simd_aligned_access(const NBase& scope, const NBase& n,
    ...
    bool AnalysisStaticInfo::is_suitable_expression(const NBase& scope, const NBase& n,
            const NodeclList& suitable_expressions,
    ...
    void AnalysisStaticInfo::print_auto_scoping_results(const NBase& scope)
    {
        static_info_map_t::const_iterator scope_static_info = _static_info_map.find(scope);
        if(scope_static_info == _static_info_map.end())
        {
