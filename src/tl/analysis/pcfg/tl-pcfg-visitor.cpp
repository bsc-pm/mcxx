...
namespace Analysis {
    ...
    ObjectList<ExtensibleGraph*> PCFGVisitor::parallel_control_flow_graph( ObjectList<Nodecl::NodeclBase> functions )
    {
...
//         }
    ...
    {
        _utils->_pragma_nodes.top( )._clauses.back( )._args.append( n );
        return PCFGVisitor::Ret( );
    }
