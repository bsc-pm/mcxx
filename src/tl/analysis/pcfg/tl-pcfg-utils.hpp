...
namespace Analysis {
    ...
    #define CLAUSE_LIST \
    CLAUSE(AssertDead) \
    CLAUSE(AssertDefined) \
    CLAUSE(AssertInductionVar) \
    CLAUSE(AssertLiveIn) \
    CLAUSE(AssertLiveOut) \
    CLAUSE(AssertReachIn) \
    CLAUSE(AssertReachOut) \
    CLAUSE(AssertUpperExposed) \
    CLAUSE(Auto) \
    CLAUSE(DepIn) \
    CLAUSE(DepInAlloca) \
    CLAUSE(DepInValue) \
    CLAUSE(DepOut) \
    CLAUSE(DepInout) \
    CLAUSE(DepConcurrent) \
    CLAUSE(DepCommutative) \
    CLAUSE(CopyIn) \
    CLAUSE(CopyOut) \
    CLAUSE(CopyInout) \
    CLAUSE(Firstprivate) \
    ...
    CLAUSE(Shared) \
    CLAUSE(Target) \
    CLAUSE(UndefinedClause) \
    CLAUSE(Untied) \
    CLAUSE(VectorDevice) \
    CLAUSE(VectorLengthFor) \
    CLAUSE(VectorMask) \
    CLAUSE(VectorNoMask) \
    CLAUSE(VectorSuitable) \
    CLAUSE(WaitOn)
